...
public abstract class SpanData {
    ...
    public static abstract class TimedEvents<T> {
        ...
        public static <T> TimedEvents<T> create(List<TimedEvent<T>> list, int i) {
            return new AutoValue_SpanData_TimedEvents(Collections.unmodifiableList(new ArrayList((Collection) Utils.checkNotNull(list, OmnitureConstants.CHANNEL))), i);
        }
    ...
    public static abstract class Links {
        ...
        public static Links create(List<Link> list, int i) {
            return new AutoValue_SpanData_Links(Collections.unmodifiableList(new ArrayList((Collection) Utils.checkNotNull(list, JSONAPISpecConstants.LINKS))), i);
        }
