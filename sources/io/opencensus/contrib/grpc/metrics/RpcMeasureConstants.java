...
public final class RpcMeasureConstants {
    ...
    public static final Measure.MeasureLong GRPC_CLIENT_RECEIVED_MESSAGES_PER_METHOD = Measure.MeasureLong.create("grpc.io/client/received_messages_per_method", "Total messages received per method.", "1");
    public static final Measure.MeasureLong GRPC_CLIENT_RECEIVED_MESSAGES_PER_RPC = Measure.MeasureLong.create("grpc.io/client/received_messages_per_rpc", "Number of response messages received per RPC", "1");
    ...
    public static final Measure.MeasureLong GRPC_CLIENT_SENT_MESSAGES_PER_METHOD = Measure.MeasureLong.create("grpc.io/client/sent_messages_per_method", "Total messages sent per method.", "1");
    public static final Measure.MeasureLong GRPC_CLIENT_SENT_MESSAGES_PER_RPC = Measure.MeasureLong.create("grpc.io/client/sent_messages_per_rpc", "Number of messages sent in the RPC", "1");
    ...
    public static final Measure.MeasureLong GRPC_CLIENT_STARTED_RPCS = Measure.MeasureLong.create("grpc.io/client/started_rpcs", "Number of started client RPCs.", "1");
    ...
    public static final Measure.MeasureLong GRPC_SERVER_RECEIVED_MESSAGES_PER_METHOD = Measure.MeasureLong.create("grpc.io/server/received_messages_per_method", "Total messages received per method.", "1");
    public static final Measure.MeasureLong GRPC_SERVER_RECEIVED_MESSAGES_PER_RPC = Measure.MeasureLong.create("grpc.io/server/received_messages_per_rpc", "Number of messages received in each RPC", "1");
    ...
    public static final Measure.MeasureLong GRPC_SERVER_SENT_MESSAGES_PER_METHOD = Measure.MeasureLong.create("grpc.io/server/sent_messages_per_method", "Total messages sent per method.", "1");
    public static final Measure.MeasureLong GRPC_SERVER_SENT_MESSAGES_PER_RPC = Measure.MeasureLong.create("grpc.io/server/sent_messages_per_rpc", "Number of messages sent in each RPC", "1");
    ...
    public static final Measure.MeasureLong GRPC_SERVER_STARTED_RPCS = Measure.MeasureLong.create("grpc.io/server/started_rpcs", "Number of started server RPCs.", "1");
