...
public final class Status {
    ...
    public static Status fromThrowable(Throwable th) {
        for (Throwable th2 = (Throwable) Preconditions.checkNotNull(th, Constants.APPBOY_PUSH_TITLE_KEY); th2 != null; th2 = th2.getCause()) {
    ...
    public Status augmentDescription(String str) {
        ...
        return new Status(code2, this.description + IOUtils.LINE_SEPARATOR_UNIX + str, this.cause);
    }
