...
public abstract class NameResolver {
    ...
    public static final class ResolutionResult {
        ...
        ResolutionResult(List<EquivalentAddressGroup> list, Attributes attributes2, ConfigOrError configOrError) {
            ...
            this.attributes = (Attributes) Preconditions.checkNotNull(attributes2, JSONAPISpecConstants.ATTRIBUTES);
        ...
        public String toString() {
            return MoreObjects.toStringHelper((Object) this).add("addresses", (Object) this.addresses).add(JSONAPISpecConstants.ATTRIBUTES, (Object) this.attributes).add("serviceConfig", (Object) this.serviceConfig).toString();
        }
    ...
    public static final class ConfigOrError {
        ...
        private ConfigOrError(Object obj) {
            this.config = Preconditions.checkNotNull(obj, Constants.CONFIG_FILE_NAME);
            this.status = null;
        }
        ...
        public String toString() {
            if (this.config != null) {
                return MoreObjects.toStringHelper((Object) this).add(Constants.CONFIG_FILE_NAME, this.config).toString();
            }
