...
abstract class RetriableStream<ReqT> implements ClientStream {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:29:0x0060, code lost:
        r3 = (io.grpc.internal.RetriableStream.BufferEntry) r2.next();
        r4 = r7.state;
     */
    ...
    class BufferSizeTracer extends ClientStreamTracer {
        ...
        public void outboundWireSize(long r8) {
            ...
            L_0x000b:
                ...
                monitor-enter(r1)
                io.grpc.internal.RetriableStream r2 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0086 }
            ...
            L_0x0024:
                ...
                io.grpc.internal.RetriableStream r8 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0086 }
            ...
            L_0x0047:
                ...
                long r2 = r7.bufferNeeded     // Catch:{ all -> 0x0086 }
                io.grpc.internal.RetriableStream r9 = io.grpc.internal.RetriableStream.this     // Catch:{ all -> 0x0086 }
