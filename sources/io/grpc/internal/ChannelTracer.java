...
final class ChannelTracer {
    ...
    static /* synthetic */ class AnonymousClass2 {
        ...
        static {
            /*
                ...
                io.grpc.InternalChannelz$ChannelTrace$Event$Severity r1 = io.grpc.InternalChannelz.ChannelTrace.Event.Severity.CT_ERROR     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$io$grpc$InternalChannelz$ChannelTrace$Event$Severity     // Catch:{ NoSuchFieldError -> 0x001d }
                io.grpc.InternalChannelz$ChannelTrace$Event$Severity r1 = io.grpc.InternalChannelz.ChannelTrace.Event.Severity.CT_WARNING     // Catch:{ NoSuchFieldError -> 0x001d }
    ...
    static void logOnly(InternalLogId internalLogId, Level level, String str) {
        if (logger.isLoggable(level)) {
            ...
            logRecord.setSourceMethodName(net.media.android.bidder.base.models.internal.Logger.LOG);
