    ...
    static final class MethodInfo {
        ...
        MethodInfo(Map<String, ?> map, boolean z, int i, int i2) {
            ...
            if (maxRequestMessageBytesFromMethodConfig != null) {
                Preconditions.checkArgument(maxRequestMessageBytesFromMethodConfig.intValue() < 0 ? false : z2, "maxOutboundMessageSize %s exceeds bounds", (Object) this.maxOutboundMessageSize);
            }
