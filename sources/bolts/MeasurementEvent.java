...
public class MeasurementEvent {
    ...
    private static Bundle getApplinkLogData(Context context, String str, Bundle bundle, Intent intent) {
        ...
        if (resolveActivity != null) {
            bundle2.putString(Name.LABEL, resolveActivity.getShortClassName());
        }
        if (APP_LINK_NAVIGATE_OUT_EVENT_NAME.equals(str)) {
            if (resolveActivity != null) {
                bundle2.putString(Constants.APP_PACKAGE, resolveActivity.getPackageName());
            }
            ...
            if (obj instanceof Bundle) {
                ...
                for (String str3 : bundle3.keySet()) {
                    ...
                    if (str2.equals("referer_app_link")) {
                        ...
                        } else if (str3.equalsIgnoreCase(Constants.APP_PACKAGE)) {
