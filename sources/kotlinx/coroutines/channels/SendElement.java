...
public final class SendElement extends Send {
    ...
    public void resumeSendClosed(Closed<?> closed) {
        ...
        this.cont.resumeWith(Result.m6constructorimpl(ResultKt.createFailure(sendException)));
    }

    public String toString() {
        return "SendElement@" + DebugStringsKt.getHexAddress(this) + ASCIIPropertyListParser.ARRAY_BEGIN_TOKEN + getPollResult() + ASCIIPropertyListParser.ARRAY_END_TOKEN;
    }
}
