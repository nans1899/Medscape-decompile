...
public abstract class AbstractSendChannel<E> implements SendChannel<E> {
    ...
    private final void helpClose(Closed<?> closed) {
        Object r2 = InlineList.m1362constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
        while (true) {
            ...
            if (receive == null) {
                ...
                r2 = InlineList.m1367plusUZ7vuAc(r2, receive);
            }
        }
        if (r2 != null) {
    ...
    public String toString() {
        return DebugStringsKt.getClassSimpleName(this) + '@' + DebugStringsKt.getHexAddress(this) + ASCIIPropertyListParser.DICTIONARY_BEGIN_TOKEN + getQueueDebugStateString() + ASCIIPropertyListParser.DICTIONARY_END_TOKEN + getBufferDebugString();
    }
    ...
    private static final class SendSelect<E, R> extends Send implements DisposableHandle {
        ...
        public String toString() {
            return "SendSelect@" + DebugStringsKt.getHexAddress(this) + ASCIIPropertyListParser.ARRAY_BEGIN_TOKEN + getPollResult() + ")[" + this.channel + ", " + this.select + ']';
        }
    }
    ...
    public static final class SendBuffered<E> extends Send {
        ...
        public String toString() {
            return "SendBuffered@" + DebugStringsKt.getHexAddress(this) + ASCIIPropertyListParser.ARRAY_BEGIN_TOKEN + this.element + ASCIIPropertyListParser.ARRAY_END_TOKEN;
        }
    }
