...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    public final java.lang.Object m1337receiveOrClosedZYPwvRU(kotlin.coroutines.Continuation<? super kotlinx.coroutines.channels.ValueOrClosed<? extends E>> r5) {
        /*
            r4 = this;
        ...
        L_0x0038:
            ...
            r0.<init>(r5)
            java.lang.Object r5 = kotlinx.coroutines.channels.ValueOrClosed.m1342constructorimpl(r0)
            goto L_0x005d
        L_0x0057:
            kotlinx.coroutines.channels.ValueOrClosed$Companion r0 = kotlinx.coroutines.channels.ValueOrClosed.Companion
            java.lang.Object r5 = kotlinx.coroutines.channels.ValueOrClosed.m1342constructorimpl(r5)
        L_0x005d:
            return r5
        L_0x005e:
            r2 = 2
        ...
        L_0x006c:
            ...
            java.lang.Object r5 = r5.m1351unboximpl()
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: kotlinx.coroutines.channels.AbstractChannel.m1337receiveOrClosedZYPwvRU(kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public void onCancelIdempotent(boolean z) {
        ...
        if (closedForSend != null) {
            Object r0 = InlineList.m1362constructorimpl$default((Object) null, 1, (DefaultConstructorMarker) null);
            while (true) {
                ...
                if (prevNode instanceof LockFreeLinkedListHead) {
                    ...
                    r0 = InlineList.m1367plusUZ7vuAc(r0, (Send) prevNode);
                } else {
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (z) {
            ...
            if (z) {
                obj2 = ValueOrClosed.m1342constructorimpl(new ValueOrClosed.Closed(((Closed) obj).closeCause));
            } else {
                obj2 = ValueOrClosed.m1342constructorimpl(obj);
            }
            UndispatchedKt.startCoroutineUnintercepted(function2, ValueOrClosed.m1341boximpl(obj2), selectInstance.getCompletion());
        } else {
                ...
                if (!getChannel().enqueueReceive(receive)) {
                    ...
                    if (!(pollInternal instanceof Closed)) {
                        if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                            ...
                            cancellableContinuation.resumeWith(Result.m6constructorimpl(boxBoolean));
                            break;
                        }
                    } else {
                        ...
                        if (closed.closeCause == null) {
                            ...
                            cancellableContinuation.resumeWith(Result.m6constructorimpl(boxBoolean2));
                        } else {
                            Throwable receiveException = closed.getReceiveException();
                            Result.Companion companion3 = Result.Companion;
                            cancellableContinuation.resumeWith(Result.m6constructorimpl(ResultKt.createFailure(receiveException)));
                        }
                    }
                } else {
    ...
    private static final class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E e) {
            ...
            ValueOrClosed.Companion companion = ValueOrClosed.Companion;
            return ValueOrClosed.m1341boximpl(ValueOrClosed.m1342constructorimpl(e));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode == 1 && closed.closeCause == null) {
                Result.Companion companion = Result.Companion;
                this.cont.resumeWith(Result.m6constructorimpl((Object) null));
            } else if (this.receiveMode == 2) {
                ValueOrClosed.Companion companion2 = ValueOrClosed.Companion;
                ValueOrClosed r3 = ValueOrClosed.m1341boximpl(ValueOrClosed.m1342constructorimpl(new ValueOrClosed.Closed(closed.closeCause)));
                Result.Companion companion3 = Result.Companion;
                this.cont.resumeWith(Result.m6constructorimpl(r3));
            } else {
                Throwable receiveException = closed.getReceiveException();
                Result.Companion companion4 = Result.Companion;
                this.cont.resumeWith(Result.m6constructorimpl(ResultKt.createFailure(receiveException)));
            }
        }
    ...
    private static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        public void completeResumeReceive(E e) {
            ...
            if (this.receiveMode == 2) {
                ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                e = ValueOrClosed.m1341boximpl(ValueOrClosed.m1342constructorimpl(e));
            }
            ...
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    if (i == 2) {
                        Function2<Object, Continuation<? super R>, Object> function2 = this.block;
                        ValueOrClosed.Companion companion = ValueOrClosed.Companion;
                        ContinuationKt.startCoroutine(function2, ValueOrClosed.m1341boximpl(ValueOrClosed.m1342constructorimpl(new ValueOrClosed.Closed(closed.closeCause))), this.select.getCompletion());
                    }
        ...
        public String toString() {
            return "ReceiveSelect@" + DebugStringsKt.getHexAddress(this) + TypePool.Default.LazyTypeDescription.GenericTypeToken.COMPONENT_TYPE_PATH + this.select + ",receiveMode=" + this.receiveMode + ']';
        }
    }
                ...
                if (!enqueueReceive(receive)) {
                    ...
                    if (!(pollInternal instanceof Closed)) {
                        if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                            ...
                            Result.Companion companion = Result.Companion;
                            cancellableContinuation.resumeWith(Result.m6constructorimpl(resumeValue));
                            break;
                        }
                    } else {
