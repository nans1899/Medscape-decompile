...
public abstract class ChannelFlow<T> implements FusibleFlow<T> {
    ...
    public ReceiveChannel<T> produceImpl(CoroutineScope coroutineScope) {
        return ProduceKt.produce$default(coroutineScope, this.context, getProduceCapacity(), CoroutineStart.ATOMIC, (Function1) null, getCollectToFun$kotlinx_coroutines_core(), 8, (Object) null);
    }
    ...
    public String toString() {
        return DebugStringsKt.getClassSimpleName(this) + TypePool.Default.LazyTypeDescription.GenericTypeToken.COMPONENT_TYPE_PATH + additionalToStringProps() + "context=" + this.context + ", capacity=" + this.capacity + ']';
    }
}
