...
final /* synthetic */ class FlowKt__ContextKt {
    ...
    public static final <T> Flow<T> buffer(Flow<? extends T> flow, int i) {
        if (!(i >= 0 || i == -2 || i == -1)) {
            ...
            return FusibleFlow.DefaultImpls.fuse$default((FusibleFlow) flow, (CoroutineContext) null, i, 1, (Object) null);
        } else {
    ...
    public static final <T> Flow<T> flowOn(Flow<? extends T> flow, CoroutineContext coroutineContext) {
        ...
        if (flow instanceof FusibleFlow) {
            return FusibleFlow.DefaultImpls.fuse$default((FusibleFlow) flow, coroutineContext, 0, 2, (Object) null);
        }
    ...
    public static final <T> Flow<T> cancellable(Flow<? extends T> flow) {
        return flow instanceof AbstractFlow ? flow : new FlowKt__ContextKt$cancellable$$inlined$unsafeFlow$1(flow);
    }
