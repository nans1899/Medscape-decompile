...
public final class TimeoutKt {
    ...
    public static final <T> Object m1335withTimeoutlwyi7ZQ(double d, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeout(DelayKt.m1334toDelayMillisLRDsOJo(d), function2, continuation);
    }
    ...
    public static final <T> Object m1336withTimeoutOrNulllwyi7ZQ(double d, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return withTimeoutOrNull(DelayKt.m1334toDelayMillisLRDsOJo(d), function2, continuation);
    }
