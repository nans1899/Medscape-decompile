...
public class JobSupport implements Job, ChildJob, ParentJob, SelectClause0 {
    ...
    public final String toDebugString() {
        return nameString$kotlinx_coroutines_core() + ASCIIPropertyListParser.DICTIONARY_BEGIN_TOKEN + stateString(getState$kotlinx_coroutines_core()) + ASCIIPropertyListParser.DICTIONARY_END_TOKEN;
    }
