...
public final class DelayKt {
    ...
    public static final Object m1333delayp9JZ4hM(double d, Continuation<? super Unit> continuation) {
        Object delay = delay(m1334toDelayMillisLRDsOJo(d), continuation);
    ...
    public static final long m1334toDelayMillisLRDsOJo(double d) {
        if (Duration.m1273compareToLRDsOJo(d, Duration.Companion.m1319getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1310toLongMillisecondsimpl(d), 1);
        }
        return 0;
    }
}
