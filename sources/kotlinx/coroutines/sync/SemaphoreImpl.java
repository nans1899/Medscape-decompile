...
final class SemaphoreImpl implements Semaphore {
    ...
    public final boolean addAcquireToQueue(CancellableContinuation<? super Unit> cancellableContinuation) {
        ...
        do {
            ...
            while (true) {
                if (segment.getId() >= access$getSEGMENT_SIZE$p && !segment.getRemoved()) {
                    obj = SegmentOrClosed.m1371constructorimpl(segment);
                    break;
                }
            ...
            Segment r8 = SegmentOrClosed.m1374getSegmentimpl(obj);
            while (true) {
        ...
        SemaphoreSegment semaphoreSegment2 = (SemaphoreSegment) SegmentOrClosed.m1374getSegmentimpl(obj);
        ...
        if (semaphoreSegment2.acquirers.compareAndSet(access$getSEGMENT_SIZE$p2, SemaphoreKt.PERMIT, SemaphoreKt.TAKEN)) {
            ...
            cancellableContinuation2.resumeWith(Result.m6constructorimpl(unit));
            return true;
        }
    ...
    private final boolean tryResumeNextFromQueue() {
        ...
        L_0x0014:
            ...
            goto L_0x0028
        L_0x0023:
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m1371constructorimpl(r5)
            goto L_0x003d
        L_0x0028:
            r6 = r5
            ...
            java.lang.Object r5 = kotlinx.coroutines.internal.SegmentOrClosed.m1371constructorimpl(r5)
        L_0x003d:
            boolean r6 = kotlinx.coroutines.internal.SegmentOrClosed.m1376isClosedimpl(r5)
            r7 = 0
            r8 = 1
            if (r6 != 0) goto L_0x0082
            kotlinx.coroutines.internal.Segment r6 = kotlinx.coroutines.internal.SegmentOrClosed.m1374getSegmentimpl(r5)
        L_0x0049:
        ...
        L_0x0078:
            ...
            goto L_0x0049
        L_0x0082:
            kotlinx.coroutines.internal.Segment r0 = kotlinx.coroutines.internal.SegmentOrClosed.m1374getSegmentimpl(r5)
            kotlinx.coroutines.sync.SemaphoreSegment r0 = (kotlinx.coroutines.sync.SemaphoreSegment) r0
            r0.cleanPrev()
            long r5 = r0.getId()
        ...
        L_0x00d4:
            ...
            boolean r0 = kotlinx.coroutines.sync.SemaphoreKt.tryResume(r1)
            return r0
        L_0x00db:
            kotlinx.coroutines.internal.ConcurrentLinkedListNode r6 = (kotlinx.coroutines.internal.ConcurrentLinkedListNode) r6
        ...
        while (true) {
            if (!addAcquireToQueue(cancellableContinuation)) {
                if (_availablePermits$FU.getAndDecrement(this) > 0) {
                    Unit unit = Unit.INSTANCE;
                    Result.Companion companion = Result.Companion;
                    cancellableContinuation.resumeWith(Result.m6constructorimpl(unit));
                    break;
                }
            } else {
                break;
