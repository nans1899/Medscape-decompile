        ...
        while (true) {
            ...
            if (obj3 instanceof Empty) {
                ...
                if (lockedQueue.owner != obj2) {
                    ...
                    LockFreeLinkedListNode.CondAddOp mutexImpl$lockSuspend$$inlined$suspendAtomicCancellableCoroutineReusable$lambda$1 = new MutexImpl$lockSuspend$$inlined$suspendAtomicCancellableCoroutineReusable$lambda$1(lockFreeLinkedListNode2, lockFreeLinkedListNode2, obj3, cancellableContinuation, lockCont, this, obj);
                    while (true) {
                        int tryCondAddNext = lockFreeLinkedListNode.getPrevNode().tryCondAddNext(lockFreeLinkedListNode3, lockFreeLinkedListNode, mutexImpl$lockSuspend$$inlined$suspendAtomicCancellableCoroutineReusable$lambda$1);
                        if (tryCondAddNext != 1) {
                            if (tryCondAddNext == 2) {
                                z = false;
                                break;
