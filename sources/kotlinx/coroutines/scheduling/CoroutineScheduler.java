            ...
            if (worker != null) {
                ...
                if (i7 == 1) {
                    ...
                    if (size$kotlinx_coroutines_core > 0) {
                        arrayList.add(String.valueOf(size$kotlinx_coroutines_core) + Constants.APPBOY_PUSH_NOTIFICATION_SOUND_DEFAULT_VALUE);
                    }
                } else if (i7 == 5) {
                    i5++;
                }
