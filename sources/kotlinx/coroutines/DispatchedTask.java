        ...
        try {
            ...
            if (delegate$kotlinx_coroutines_core != null) {
                ...
                if (exceptionalResult$kotlinx_coroutines_core == null && job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m6constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    ...
                    continuation.resumeWith(Result.m6constructorimpl(successfulResult$kotlinx_coroutines_core));
                }
                ...
                try {
                    ...
                    obj2 = Result.m6constructorimpl(Unit.INSTANCE);
                } catch (Throwable th3) {
                    Result.Companion companion5 = Result.Companion;
                    obj2 = Result.m6constructorimpl(ResultKt.createFailure(th3));
                }
                handleFatalException$kotlinx_coroutines_core(th2, Result.m9exceptionOrNullimpl(obj2));
                return;
            }
            ...
            try {
                ...
                taskContext.afterTask();
                obj = Result.m6constructorimpl(Unit.INSTANCE);
            } catch (Throwable th5) {
                Result.Companion companion7 = Result.Companion;
                obj = Result.m6constructorimpl(ResultKt.createFailure(th5));
            }
            handleFatalException$kotlinx_coroutines_core(th4, Result.m9exceptionOrNullimpl(obj));
        }
    }
