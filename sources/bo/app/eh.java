...
public class eh {
    ...
    public static java.lang.String a(java.lang.String r6, java.lang.String r7) {
        ...
        L_0x0031:
            ...
            com.appboy.support.AppboyLogger.e(r1, r0, r6)
            goto L_0x004d
        L_0x0038:
            r6 = move-exception
            r1 = r2
        ...
        L_0x0040:
            r6 = move-exception
        L_0x0041:
            java.lang.String r2 = a     // Catch:{ all -> 0x003e }
            java.lang.String r3 = "Caught exception while trying to read Braze logger tag from system properties."
            com.appboy.support.AppboyLogger.e(r2, r3, r6)     // Catch:{ all -> 0x003e }
        ...
        L_0x0054:
            r7 = move-exception
            java.lang.String r1 = a
            com.appboy.support.AppboyLogger.e(r1, r0, r7)
        L_0x005a:
            throw r6
        */
        throw new UnsupportedOperationException("Method not decompiled: bo.app.eh.a(java.lang.String, java.lang.String):java.lang.String");
    }
}
