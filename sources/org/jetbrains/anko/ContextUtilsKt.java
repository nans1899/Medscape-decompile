        ...
        for (Pair<String, ? extends Object> pair : pairArr) {
            ...
            if (component2 == null) {
                ...
                if (objArr instanceof Parcelable[]) {
                    ...
                    throw new AnkoException("Unsupported bundle component (" + objArr.getClass() + ASCIIPropertyListParser.ARRAY_END_TOKEN);
                ...
                throw new AnkoException("Unsupported bundle component (" + component2.getClass() + ASCIIPropertyListParser.ARRAY_END_TOKEN);
            }
        }
        return bundle;
    }
