...
public final class AndroidAlertBuilder implements AlertBuilder<AlertDialog> {
    ...
    public void items(List<? extends CharSequence> list, Function2<? super DialogInterface, ? super Integer, Unit> function2) {
        ...
        builder2.setItems((CharSequence[]) strArr, new AndroidAlertBuilder$items$2(function2));
    }
    ...
    public <T> void items(List<? extends T> list, Function3<? super DialogInterface, ? super T, ? super Integer, Unit> function3) {
        ...
        builder2.setItems((CharSequence[]) strArr, new AndroidAlertBuilder$items$4(function3, list));
    }
