...
final class Preconditions {
    ...
    private static String badPositionIndexes(int i, int i2, int i3) {
        ...
        return String.format("end index (%s) must not be less than start index (%s)", new Object[]{Integer.valueOf(i2), Integer.valueOf(i)});
    }
    ...
    private static String badPositionIndex(int i, int i2, String str) {
        if (i < 0) {
            ...
            return String.format("%s (%s) must not be greater than size (%s)", new Object[]{str, Integer.valueOf(i), Integer.valueOf(i2)});
        } else {
