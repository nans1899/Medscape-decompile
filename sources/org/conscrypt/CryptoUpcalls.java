...
final class CryptoUpcalls {
    ...
    private static byte[] signDigestWithPrivateKey(java.security.PrivateKey r5, byte[] r6, java.lang.String r7) {
        /*
            ...
            boolean r2 = org.conscrypt.Conscrypt.isConscrypt((java.security.Provider) r2)     // Catch:{ NoSuchAlgorithmException -> 0x009c, InvalidKeyException -> 0x0013 }
    ...
    private static byte[] rsaOpWithPrivateKey(java.security.PrivateKey r5, int r6, int r7, byte[] r8) {
        ...
        L_0x004e:
            ...
            boolean r0 = org.conscrypt.Conscrypt.isConscrypt((java.security.Provider) r2)     // Catch:{ NoSuchAlgorithmException -> 0x010b, NoSuchPaddingException -> 0x00f6, InvalidKeyException -> 0x0071 }
