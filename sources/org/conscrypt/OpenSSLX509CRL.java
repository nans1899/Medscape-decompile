...
final class OpenSSLX509CRL extends X509CRL {
    ...
    public boolean hasUnsupportedCriticalExtension() {
        for (String X509_CRL_get_ext : NativeCrypto.get_X509_CRL_ext_oids(this.mContext, this, 1)) {
            if (NativeCrypto.X509_supported_extension(NativeCrypto.X509_CRL_get_ext(this.mContext, this, X509_CRL_get_ext)) != 1) {
                return true;
            }
        }
        return false;
    ...
    public Set<? extends X509CRLEntry> getRevokedCertificates() {
        ...
        for (long openSSLX509CRLEntry : X509_CRL_get_REVOKED) {
            try {
                hashSet.add(new OpenSSLX509CRLEntry(openSSLX509CRLEntry));
            } catch (OpenSSLX509CertificateFactory.ParsingException unused) {
            }
        }
        return hashSet;
