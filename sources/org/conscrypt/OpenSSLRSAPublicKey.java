...
public class OpenSSLRSAPublicKey implements RSAPublicKey, OpenSSLKeyHolder {
    ...
    public String toString() {
        ensureReadParams();
        return "OpenSSLRSAPublicKey{" + "modulus=" + this.modulus.toString(16) + ASCIIPropertyListParser.ARRAY_ITEM_DELIMITER_TOKEN + "publicExponent=" + this.publicExponent.toString(16) + ASCIIPropertyListParser.DICTIONARY_END_TOKEN;
    }
