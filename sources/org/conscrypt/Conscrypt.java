...
public final class Conscrypt {
    ...
    static {
        /*
            ...
            java.io.InputStream r2 = r2.getResourceAsStream(r3)     // Catch:{ IOException -> 0x0038 }
            if (r2 == 0) goto L_0x0035
            java.util.Properties r3 = new java.util.Properties     // Catch:{ IOException -> 0x0038 }
            r3.<init>()     // Catch:{ IOException -> 0x0038 }
            r3.load(r2)     // Catch:{ IOException -> 0x0038 }
            java.lang.String r2 = "org.conscrypt.version.major"
            java.lang.String r2 = r3.getProperty(r2, r0)     // Catch:{ IOException -> 0x0038 }
            int r2 = java.lang.Integer.parseInt(r2)     // Catch:{ IOException -> 0x0038 }
            java.lang.String r4 = "org.conscrypt.version.minor"
            java.lang.String r4 = r3.getProperty(r4, r0)     // Catch:{ IOException -> 0x0039 }
            int r4 = java.lang.Integer.parseInt(r4)     // Catch:{ IOException -> 0x0039 }
            java.lang.String r5 = "org.conscrypt.version.patch"
            java.lang.String r0 = r3.getProperty(r5, r0)     // Catch:{ IOException -> 0x003a }
            int r0 = java.lang.Integer.parseInt(r0)     // Catch:{ IOException -> 0x003a }
            r1 = r2
            goto L_0x003c
        L_0x0035:
            r0 = -1
