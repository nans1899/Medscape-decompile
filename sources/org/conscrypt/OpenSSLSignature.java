...
public class OpenSSLSignature extends SignatureSpi {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            /*
                org.conscrypt.OpenSSLSignature$EngineType[] r0 = org.conscrypt.OpenSSLSignature.EngineType.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                $SwitchMap$org$conscrypt$OpenSSLSignature$EngineType = r0
                org.conscrypt.OpenSSLSignature$EngineType r1 = org.conscrypt.OpenSSLSignature.EngineType.RSA     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = $SwitchMap$org$conscrypt$OpenSSLSignature$EngineType     // Catch:{ NoSuchFieldError -> 0x001d }
                org.conscrypt.OpenSSLSignature$EngineType r1 = org.conscrypt.OpenSSLSignature.EngineType.EC     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: org.conscrypt.OpenSSLSignature.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    static abstract class RSAPKCS1Padding extends OpenSSLSignature {
        RSAPKCS1Padding(long j) {
            super(j, EngineType.RSA, (AnonymousClass1) null);
        }
    ...
    public static final class SHA1ECDSA extends OpenSSLSignature {
        public SHA1ECDSA() {
            super(EvpMdRef.SHA1.EVP_MD, EngineType.EC, (AnonymousClass1) null);
        }
    }

    public static final class SHA224ECDSA extends OpenSSLSignature {
        public SHA224ECDSA() {
            super(EvpMdRef.SHA224.EVP_MD, EngineType.EC, (AnonymousClass1) null);
        }
    }

    public static final class SHA256ECDSA extends OpenSSLSignature {
        public SHA256ECDSA() {
            super(EvpMdRef.SHA256.EVP_MD, EngineType.EC, (AnonymousClass1) null);
        }
    }

    public static final class SHA384ECDSA extends OpenSSLSignature {
        public SHA384ECDSA() {
            super(EvpMdRef.SHA384.EVP_MD, EngineType.EC, (AnonymousClass1) null);
        }
    }

    public static final class SHA512ECDSA extends OpenSSLSignature {
        public SHA512ECDSA() {
            super(EvpMdRef.SHA512.EVP_MD, EngineType.EC, (AnonymousClass1) null);
        }
    }
