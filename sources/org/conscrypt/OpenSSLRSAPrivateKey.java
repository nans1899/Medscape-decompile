...
class OpenSSLRSAPrivateKey implements RSAPrivateKey, OpenSSLKeyHolder {
    ...
    private static OpenSSLKey init(RSAPrivateKeySpec rSAPrivateKeySpec) throws InvalidKeySpecException {
        ...
        if (modulus2 == null) {
            ...
            try {
                return new OpenSSLKey(NativeCrypto.EVP_PKEY_new_RSA(modulus2.toByteArray(), (byte[]) null, privateExponent2.toByteArray(), (byte[]) null, (byte[]) null, (byte[]) null, (byte[]) null, (byte[]) null));
            } catch (Exception e) {
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        this.key = new OpenSSLKey(NativeCrypto.EVP_PKEY_new_RSA(this.modulus.toByteArray(), (byte[]) null, this.privateExponent.toByteArray(), (byte[]) null, (byte[]) null, (byte[]) null, (byte[]) null, (byte[]) null));
        this.fetchedParams = true;
    }
