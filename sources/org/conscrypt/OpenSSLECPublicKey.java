...
final class OpenSSLECPublicKey implements ECPublicKey, OpenSSLKeyHolder {
    ...
    OpenSSLECPublicKey(ECPublicKeySpec eCPublicKeySpec) throws InvalidKeySpecException {
        try {
            ...
            this.group = instance;
            this.key = new OpenSSLKey(NativeCrypto.EVP_PKEY_new_EC_KEY(this.group.getNativeRef(), OpenSSLECPointContext.getInstance(instance, eCPublicKeySpec.getW()).getNativeRef(), (byte[]) null));
        } catch (Exception e) {
    ...
    static OpenSSLKey getInstance(ECPublicKey eCPublicKey) throws InvalidKeyException {
        try {
            ...
            return new OpenSSLKey(NativeCrypto.EVP_PKEY_new_EC_KEY(instance.getNativeRef(), OpenSSLECPointContext.getInstance(instance, eCPublicKey.getW()).getNativeRef(), (byte[]) null));
        } catch (Exception e) {
