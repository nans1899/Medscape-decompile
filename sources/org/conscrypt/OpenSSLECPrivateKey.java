...
final class OpenSSLECPrivateKey implements ECPrivateKey, OpenSSLKeyHolder {
    ...
    OpenSSLECPrivateKey(ECPrivateKeySpec eCPrivateKeySpec) throws InvalidKeySpecException {
        try {
            ...
            this.key = new OpenSSLKey(NativeCrypto.EVP_PKEY_new_EC_KEY(this.group.getNativeRef(), (NativeRef.EC_POINT) null, eCPrivateKeySpec.getS().toByteArray()));
        } catch (Exception e) {
    ...
    static OpenSSLKey getInstance(ECPrivateKey eCPrivateKey) throws InvalidKeyException {
        try {
            ...
            return new OpenSSLKey(NativeCrypto.EVP_PKEY_new_EC_KEY(instance.getNativeRef(), (NativeRef.EC_POINT) null, eCPrivateKey.getS().toByteArray()));
        } catch (Exception e) {
