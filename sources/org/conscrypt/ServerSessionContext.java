...
public final class ServerSessionContext extends AbstractSessionContext {
    ...
    public NativeSslSession getSessionFromPersistentCache(byte[] bArr) {
        ...
        if (sSLServerSessionCache == null || (sessionData = sSLServerSessionCache.getSessionData(bArr)) == null || (newInstance = NativeSslSession.newInstance(this, sessionData, (String) null, -1)) == null || !newInstance.isValid()) {
            return null;
        }
