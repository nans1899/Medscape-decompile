...
public class DateTimeZoneBuilder {
    ...
    static void writeMillis(DataOutput dataOutput, long j) throws IOException {
        ...
        if (j % Constants.MINUTE_IN_MILLIS == 0) {
            long j3 = j / Constants.MINUTE_IN_MILLIS;
            if (((j3 << 34) >> 34) == j3) {
    ...
    private static final class Transition {
        ...
        public String toString() {
            return new DateTime(this.iMillis, DateTimeZone.UTC) + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this.iStandardOffset + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this.iWallOffset;
        }
    }
    ...
    private static final class RuleSet {
        ...
        public String toString() {
            return this.iInitialNameKey + " initial: " + this.iInitialSaveMillis + " std: " + this.iStandardOffset + " upper: " + this.iUpperYear + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this.iUpperOfYear + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + this.iRules;
        }
    }
