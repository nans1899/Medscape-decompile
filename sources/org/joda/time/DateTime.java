    ...
    public static final class Property extends AbstractReadableInstantFieldProperty {
        ...
        public DateTime withMaximumValue() {
            try {
                ...
                if (IllegalInstantException.isIllegalInstant(e)) {
                    return new DateTime(getChronology().getZone().previousTransition(getMillis() + Constants.DAY_IN_MILLIS), getChronology());
                }
                throw e;
            }
        }
        ...
        public DateTime withMinimumValue() {
            try {
                ...
                if (IllegalInstantException.isIllegalInstant(e)) {
                    return new DateTime(getChronology().getZone().nextTransition(getMillis() - Constants.DAY_IN_MILLIS), getChronology());
                }
                throw e;
            }
        }
