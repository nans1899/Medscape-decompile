...
public final class LocalDate extends BaseLocal implements ReadablePartial, Serializable {
    ...
    public DateTime toDateTimeAtStartOfDay(DateTimeZone dateTimeZone) {
        ...
        return new DateTime(withZone.dayOfMonth().roundFloor(zone.convertLocalToUTC(getLocalMillis() + Constants.BG_UPDATE_TIME_IN_MILLIS, false)), withZone);
    }
    ...
    public Date toDate() {
        ...
        if (fromDateFields.isBefore(this)) {
            while (!fromDateFields.equals(this)) {
                date.setTime(date.getTime() + Constants.HOUR_IN_MILLIS);
