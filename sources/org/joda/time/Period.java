...
public final class Period extends BasePeriod implements ReadablePeriod, Serializable {
    ...
    public Weeks toStandardWeeks() {
        ...
        return Weeks.weeks(FieldUtils.safeToInt(((long) getWeeks()) + (((((((long) getMillis()) + (((long) getSeconds()) * 1000)) + (((long) getMinutes()) * Constants.MINUTE_IN_MILLIS)) + (((long) getHours()) * Constants.HOUR_IN_MILLIS)) + (((long) getDays()) * Constants.DAY_IN_MILLIS)) / 604800000)));
    }

    public Days toStandardDays() {
        checkYearsAndMonths("Days");
        return Days.days(FieldUtils.safeToInt(FieldUtils.safeAdd(FieldUtils.safeAdd((((((long) getMillis()) + (((long) getSeconds()) * 1000)) + (((long) getMinutes()) * Constants.MINUTE_IN_MILLIS)) + (((long) getHours()) * Constants.HOUR_IN_MILLIS)) / Constants.DAY_IN_MILLIS, (long) getDays()), ((long) getWeeks()) * 7)));
    }

    public Hours toStandardHours() {
        checkYearsAndMonths("Hours");
        return Hours.hours(FieldUtils.safeToInt(FieldUtils.safeAdd(FieldUtils.safeAdd(FieldUtils.safeAdd(((((long) getMillis()) + (((long) getSeconds()) * 1000)) + (((long) getMinutes()) * Constants.MINUTE_IN_MILLIS)) / Constants.HOUR_IN_MILLIS, (long) getHours()), ((long) getDays()) * 24), ((long) getWeeks()) * 168)));
    }

    public Minutes toStandardMinutes() {
        checkYearsAndMonths("Minutes");
        return Minutes.minutes(FieldUtils.safeToInt(FieldUtils.safeAdd(FieldUtils.safeAdd(FieldUtils.safeAdd(FieldUtils.safeAdd((((long) getMillis()) + (((long) getSeconds()) * 1000)) / Constants.MINUTE_IN_MILLIS, (long) getMinutes()), ((long) getHours()) * 60), ((long) getDays()) * 1440), ((long) getWeeks()) * 10080)));
    }
    ...
    public Duration toStandardDuration() {
        ...
        return new Duration(((long) getMillis()) + (((long) getSeconds()) * 1000) + (((long) getMinutes()) * Constants.MINUTE_IN_MILLIS) + (((long) getHours()) * Constants.HOUR_IN_MILLIS) + (((long) getDays()) * Constants.DAY_IN_MILLIS) + (((long) getWeeks()) * 604800000));
    }
    ...
    public Period normalizedStandard(PeriodType periodType) {
        PeriodType periodType2 = DateTimeUtils.getPeriodType(periodType);
        Period period = new Period(((long) getMillis()) + (((long) getSeconds()) * 1000) + (((long) getMinutes()) * Constants.MINUTE_IN_MILLIS) + (((long) getHours()) * Constants.HOUR_IN_MILLIS) + (((long) getDays()) * Constants.DAY_IN_MILLIS) + (((long) getWeeks()) * 604800000), periodType2, (Chronology) ISOChronology.getInstanceUTC());
        int years = getYears();
