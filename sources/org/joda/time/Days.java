...
public final class Days extends BaseSingleFieldPeriod {
    ...
    public static Days standardDaysIn(ReadablePeriod readablePeriod) {
        return days(BaseSingleFieldPeriod.standardPeriodIn(readablePeriod, Constants.DAY_IN_MILLIS));
    }
    ...
    public Duration toStandardDuration() {
        return new Duration(((long) getValue()) * Constants.DAY_IN_MILLIS);
    }
    ...
    public String toString() {
        return "P" + String.valueOf(getValue()) + SearchHelper.TYPE_DRUG;
    }
}
