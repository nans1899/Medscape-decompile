...
public class FormElement extends Element {
    ...
    public Connection submit() {
        ...
        return Jsoup.connect(absUrl).data((Collection<Connection.KeyVal>) formData()).method(attr(FirebaseAnalytics.Param.METHOD).toUpperCase().equals("POST") ? Connection.Method.POST : Connection.Method.GET);
    }
