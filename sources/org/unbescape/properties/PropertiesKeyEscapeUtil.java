...
final class PropertiesKeyEscapeUtil {
    ...
    static {
        ...
        cArr2[32] = ' ';
        cArr2[58] = ASCIIPropertyListParser.DATE_TIME_FIELD_DELIMITER;
        cArr2[59] = '=';
        cArr2[92] = '\\';
    ...
    static String escape(String str, PropertiesKeyEscapeLevel propertiesKeyEscapeLevel) {
        char c;
    ...
    static void escape(Reader reader, Writer writer, PropertiesKeyEscapeLevel propertiesKeyEscapeLevel) throws IOException {
        char c;
        if (reader != null) {
            int escapeLevel = propertiesKeyEscapeLevel.getEscapeLevel();
    ...
    static void escape(char[] cArr, int i, int i2, Writer writer, PropertiesKeyEscapeLevel propertiesKeyEscapeLevel) throws IOException {
        char c;
