...
public class WriterOutputStream extends OutputStream {
    ...
    public WriterOutputStream(Writer writer2, Charset charset, int i, boolean z) {
        this(writer2, charset.newDecoder().onMalformedInput(CodingErrorAction.REPLACE).onUnmappableCharacter(CodingErrorAction.REPLACE).replaceWith(TypeDescription.Generic.OfWildcardType.SYMBOL), i, z);
    }
