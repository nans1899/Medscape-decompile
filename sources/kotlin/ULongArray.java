...
public final class ULongArray implements Collection<ULong>, KMappedMarker {
    ...
    public static long[] m208constructorimpl(long[] jArr) {
    ...
    public static boolean m211equalsimpl(long[] jArr, Object obj) {
        return (obj instanceof ULongArray) && Intrinsics.areEqual((Object) jArr, (Object) ((ULongArray) obj).m222unboximpl());
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof ULong) {
            return m221containsVKZWuLQ(((ULong) obj).m205unboximpl());
        }
        return false;
    }
    ...
    public static final long m213getsVKNKU(long[] jArr, int i) {
    ...
    private static final class Iterator extends ULongIterator {
        ...
        public long m223nextULongsVKNKU() {
            int i = this.index;
    ...
    public static boolean m210containsAllimpl(long[] jArr, Collection<ULong> collection) {
        boolean z;
        Intrinsics.checkNotNullParameter(collection, MessengerShareContentUtility.ELEMENTS);
        Iterable iterable = collection;
        if (!((Collection) iterable).isEmpty()) {
            for (Object next : iterable) {
                if (!(next instanceof ULong) || !ArraysKt.contains(jArr, ((ULong) next).m205unboximpl())) {
                    z = false;
                    continue;
                } else {
                    z = true;
