...
class MapsKt___MapsKt extends MapsKt__MapsKt {
    ...
    private static final <K, V> float m413maxOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Float> function1) {
        Iterator it = map.entrySet().iterator();
        if (it.hasNext()) {
    ...
    /* renamed from: maxOf  reason: collision with other method in class */
    private static final <K, V, R extends Comparable<? super R>> R m414maxOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> function1) {
        Iterator it = map.entrySet().iterator();
        if (it.hasNext()) {
    ...
    private static final <K, V> Double m415maxOfOrNull(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Double> function1) {
        Iterator it = map.entrySet().iterator();
        if (!it.hasNext()) {
            return null;
        }
    ...
    /* renamed from: maxOfOrNull  reason: collision with other method in class */
    private static final <K, V> Float m416maxOfOrNull(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Float> function1) {
        Iterator it = map.entrySet().iterator();
        if (!it.hasNext()) {
            return null;
        }
    ...
    private static final <K, V> float m417minOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Float> function1) {
        Iterator it = map.entrySet().iterator();
        if (it.hasNext()) {
            float floatValue = function1.invoke(it.next()).floatValue();
            while (it.hasNext()) {
    ...
    /* renamed from: minOf  reason: collision with other method in class */
    private static final <K, V, R extends Comparable<? super R>> R m418minOf(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, ? extends R> function1) {
        Iterator it = map.entrySet().iterator();
        if (it.hasNext()) {
            R r = (Comparable) function1.invoke(it.next());
            while (it.hasNext()) {
    ...
    private static final <K, V> Double m419minOfOrNull(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Double> function1) {
        Iterator it = map.entrySet().iterator();
        if (!it.hasNext()) {
            return null;
        }
    ...
    /* renamed from: minOfOrNull  reason: collision with other method in class */
    private static final <K, V> Float m420minOfOrNull(Map<? extends K, ? extends V> map, Function1<? super Map.Entry<? extends K, ? extends V>, Float> function1) {
        Iterator it = map.entrySet().iterator();
        if (!it.hasNext()) {
            return null;
        }
