...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m67constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m78setVurrAj0(r0, i, r2.m65unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        ...
        int[] r0 = UIntArray.m137constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m148setVXSXFK8(r0, i, r2.m135unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        ...
        long[] r0 = ULongArray.m207constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m218setk8EXiF4(r0, i, r2.m205unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        ...
        short[] r0 = UShortArray.m303constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m314set01HTLdE(r0, i, r2.m301unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt r1 : iterable) {
            i = UInt.m92constructorimpl(i + r1.m135unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong r2 : iterable) {
            j = ULong.m162constructorimpl(j + r2.m205unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte r1 : iterable) {
            i = UInt.m92constructorimpl(i + UInt.m92constructorimpl(r1.m65unboximpl() & 255));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort r1 : iterable) {
            i = UInt.m92constructorimpl(i + UInt.m92constructorimpl(r1.m301unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
