...
public final class DurationKt {
    ...
    private static final double m1321timesmvk6XK0(int i, double d) {
        return Duration.m1301timesUwyO8pc(d, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final double m1320timeskIfJnKk(double d, double d2) {
        return Duration.m1300timesUwyO8pc(d2, d);
    }

    public static final double toDuration(double d, TimeUnit timeUnit) {
        Intrinsics.checkNotNullParameter(timeUnit, "unit");
        return Duration.m1274constructorimpl(DurationUnitKt.convertDurationUnit(d, timeUnit, TimeUnit.NANOSECONDS));
    }
}
