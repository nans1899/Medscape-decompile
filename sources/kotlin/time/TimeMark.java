...
public abstract class TimeMark {
    ...
    public abstract double m1324elapsedNowUwyO8pc();

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1326plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this, d, (DefaultConstructorMarker) null);
    }

    /* renamed from: minus-LRDsOJo  reason: not valid java name */
    public TimeMark m1325minusLRDsOJo(double d) {
        return m1326plusLRDsOJo(Duration.m1315unaryMinusUwyO8pc(d));
    }

    public final boolean hasPassedNow() {
        return !Duration.m1295isNegativeimpl(m1324elapsedNowUwyO8pc());
    }
