...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final double m1268getAdjustmentUwyO8pc() {
    ...
    public double m1267elapsedNowUwyO8pc() {
        return Duration.m1297minusLRDsOJo(this.mark.m1324elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1269plusLRDsOJo(double d) {
        return new AdjustedTimeMark(this.mark, Duration.m1298plusLRDsOJo(this.adjustment, d), (DefaultConstructorMarker) null);
    }
}
