...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m1327copyRFiDyg4$default(TimedValue timedValue, T t, double d, int i, Object obj) {
        if ((i & 1) != 0) {
            t = timedValue.value;
        }
        if ((i & 2) != 0) {
        ...
        return timedValue.m1329copyRFiDyg4(t, d);
    }
    ...
    public final double m1328component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m1329copyRFiDyg4(T t, double d) {
    ...
    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m1312toStringimpl(this.duration) + ")";
    }
    ...
    public final double m1330getDurationUwyO8pc() {
        return this.duration;
    }
