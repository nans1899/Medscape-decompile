...
public final class ULong implements Comparable<ULong> {
    ...
    public static boolean m168equalsimpl(long j, Object obj) {
        return (obj instanceof ULong) && j == ((ULong) obj).m205unboximpl();
    }
    ...
    private static final long m202toULongsVKNKU(long j) {
        return j;
    }
    ...
    public /* bridge */ /* synthetic */ int compareTo(Object obj) {
        return m158compareToVKZWuLQ(((ULong) obj).m205unboximpl());
    }
    ...
    private static final int m157compareTo7apg3OU(long j, byte b) {
        return UnsignedKt.ulongCompare(j, m162constructorimpl(((long) b) & 255));
    }

    /* renamed from: compareTo-xj2QHRw  reason: not valid java name */
    private static final int m161compareToxj2QHRw(long j, short s) {
        return UnsignedKt.ulongCompare(j, m162constructorimpl(((long) s) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    /* renamed from: compareTo-WZ4Q5Ns  reason: not valid java name */
    private static final int m160compareToWZ4Q5Ns(long j, int i) {
        return UnsignedKt.ulongCompare(j, m162constructorimpl(((long) i) & 4294967295L));
    }
    ...
    private static final long m178plus7apg3OU(long j, byte b) {
        return m162constructorimpl(j + m162constructorimpl(((long) b) & 255));
    }

    /* renamed from: plus-xj2QHRw  reason: not valid java name */
    private static final long m181plusxj2QHRw(long j, short s) {
        return m162constructorimpl(j + m162constructorimpl(((long) s) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    /* renamed from: plus-WZ4Q5Ns  reason: not valid java name */
    private static final long m180plusWZ4Q5Ns(long j, int i) {
        return m162constructorimpl(j + m162constructorimpl(((long) i) & 4294967295L));
    }
    ...
    private static final long m164div7apg3OU(long j, byte b) {
        return UnsignedKt.m323ulongDivideeb3DHEI(j, m162constructorimpl(((long) b) & 255));
    }

    /* renamed from: div-xj2QHRw  reason: not valid java name */
    private static final long m167divxj2QHRw(long j, short s) {
        return UnsignedKt.m323ulongDivideeb3DHEI(j, m162constructorimpl(((long) s) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    /* renamed from: div-WZ4Q5Ns  reason: not valid java name */
    private static final long m166divWZ4Q5Ns(long j, int i) {
        return UnsignedKt.m323ulongDivideeb3DHEI(j, m162constructorimpl(((long) i) & 4294967295L));
    }

    /* renamed from: div-VKZWuLQ  reason: not valid java name */
    private static final long m165divVKZWuLQ(long j, long j2) {
        return UnsignedKt.m323ulongDivideeb3DHEI(j, j2);
    }

    /* renamed from: rem-7apg3OU  reason: not valid java name */
    private static final long m183rem7apg3OU(long j, byte b) {
        return UnsignedKt.m324ulongRemaindereb3DHEI(j, m162constructorimpl(((long) b) & 255));
    }

    /* renamed from: rem-xj2QHRw  reason: not valid java name */
    private static final long m186remxj2QHRw(long j, short s) {
        return UnsignedKt.m324ulongRemaindereb3DHEI(j, m162constructorimpl(((long) s) & WebSocketProtocol.PAYLOAD_SHORT_MAX));
    }

    /* renamed from: rem-WZ4Q5Ns  reason: not valid java name */
    private static final long m185remWZ4Q5Ns(long j, int i) {
        return UnsignedKt.m324ulongRemaindereb3DHEI(j, m162constructorimpl(((long) i) & 4294967295L));
    }

    /* renamed from: rem-VKZWuLQ  reason: not valid java name */
    private static final long m184remVKZWuLQ(long j, long j2) {
        return UnsignedKt.m324ulongRemaindereb3DHEI(j, j2);
    }

    /* renamed from: inc-s-VKNKU  reason: not valid java name */
    private static final long m171incsVKNKU(long j) {
        return m162constructorimpl(j + 1);
    }

    /* renamed from: dec-s-VKNKU  reason: not valid java name */
    private static final long m163decsVKNKU(long j) {
        return m162constructorimpl(j - 1);
    }
    ...
    private static final long m187shlsVKNKU(long j, int i) {
        return m162constructorimpl(j << i);
    }

    /* renamed from: shr-s-VKNKU  reason: not valid java name */
    private static final long m188shrsVKNKU(long j, int i) {
        return m162constructorimpl(j >>> i);
    }
    ...
    private static final long m172invsVKNKU(long j) {
        return m162constructorimpl(~j);
    }

    /* renamed from: toUByte-w2LRezQ  reason: not valid java name */
    private static final byte m200toUBytew2LRezQ(long j) {
        return UByte.m24constructorimpl((byte) ((int) j));
    }

    /* renamed from: toUShort-Mh2AYeg  reason: not valid java name */
    private static final short m203toUShortMh2AYeg(long j) {
        return UShort.m260constructorimpl((short) ((int) j));
    }

    /* renamed from: toUInt-pVg5ArA  reason: not valid java name */
    private static final int m201toUIntpVg5ArA(long j) {
        return UInt.m92constructorimpl((int) j);
    }
