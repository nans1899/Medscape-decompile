...
public final class UStringsKt {
    ...
    public static final String m1260toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1262toStringolVBNx4(short s, int i) {
    ...
    public static final String m1261toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m1259toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m65unboximpl();
        }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m135unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m205unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m135unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m92constructorimpl(255)) > 0) {
            return null;
        }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m135unboximpl();
        if (UnsignedKt.uintCompare(r1, UInt.m92constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m254boximpl(UShort.m260constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r5 = UInt.m92constructorimpl(i);
        int i4 = 119304647;
        while (i3 < length) {
            ...
            if (UnsignedKt.uintCompare(i2, i4) > 0) {
                if (i4 == 119304647) {
                    i4 = UnsignedKt.m321uintDivideJ1ME1BU(-1, r5);
                    if (UnsignedKt.uintCompare(i2, i4) > 0) {
                    }
                }
                return null;
            }
            int r3 = UInt.m92constructorimpl(i2 * r5);
            int r8 = UInt.m92constructorimpl(UInt.m92constructorimpl(digitOf) + r3);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r9 = ULong.m162constructorimpl((long) i2);
        long j2 = 0;
        ...
        while (i3 < length) {
            ...
            if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                if (j3 == 512409557603043100L) {
                    j3 = UnsignedKt.m323ulongDivideeb3DHEI(j, r9);
                    if (UnsignedKt.ulongCompare(j2, j3) > 0) {
                    }
                }
                return null;
            }
            long r11 = ULong.m162constructorimpl(j2 * r9);
            long r4 = ULong.m162constructorimpl(ULong.m162constructorimpl(((long) UInt.m92constructorimpl(digitOf)) & 4294967295L) + r11);
