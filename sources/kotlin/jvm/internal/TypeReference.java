...
public final class TypeReference implements KType {
    ...
    private final String asString() {
        ...
        if (getArguments().isEmpty()) {
            ...
            str2 = CollectionsKt.joinToString$default(getArguments(), ", ", HtmlObject.HtmlMarkUp.OPEN_BRACKER, HtmlObject.HtmlMarkUp.CLOSE_BRACKER, 0, (CharSequence) null, new TypeReference$asString$args$1(this), 24, (Object) null);
        }
        if (isMarkedNullable()) {
