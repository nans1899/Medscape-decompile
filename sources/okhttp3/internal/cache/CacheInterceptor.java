    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers headers, Headers headers2) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                if (!StringsKt.equals(com.google.common.net.HttpHeaders.WARNING, name, true) || !StringsKt.startsWith$default(value, AppEventsConstants.EVENT_PARAM_VALUE_YES, false, 2, (Object) null)) {
        ...
        private final boolean isContentSpecificHeader(String str) {
            if (StringsKt.equals(com.google.common.net.HttpHeaders.CONTENT_LENGTH, str, true) || StringsKt.equals("Content-Encoding", str, true) || StringsKt.equals("Content-Type", str, true)) {
                return true;
            }
            return false;
        }
