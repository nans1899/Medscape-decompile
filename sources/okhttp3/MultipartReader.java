...
public final class MultipartReader implements Closeable {
    ...
    public static final Options afterBoundaryOptions = Options.Companion.of(ByteString.Companion.encodeUtf8(IOUtils.LINE_SEPARATOR_WINDOWS), ByteString.Companion.encodeUtf8("--"), ByteString.Companion.encodeUtf8(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR), ByteString.Companion.encodeUtf8("\t"));
