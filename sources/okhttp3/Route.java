...
public final class Route {
    ...
    public final Address m1511deprecated_address() {
        return this.address;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "proxy", imports = {}))
    /* renamed from: -deprecated_proxy  reason: not valid java name */
    public final Proxy m1512deprecated_proxy() {
        return this.proxy;
    }
    ...
    public final InetSocketAddress m1513deprecated_socketAddress() {
        return this.socketAddress;
    }
    ...
    public String toString() {
        return "Route{" + this.socketAddress + ASCIIPropertyListParser.DICTIONARY_END_TOKEN;
    }
}
