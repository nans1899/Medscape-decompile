...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1408deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1410deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean m1409deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }
    ...
    public String toString() {
        ...
        return "ConnectionSpec(" + "cipherSuites=" + Objects.toString(cipherSuites(), "[all enabled]") + ", " + "tlsVersions=" + Objects.toString(tlsVersions(), "[all enabled]") + ", " + "supportsTlsExtensions=" + this.supportsTlsExtensions + ASCIIPropertyListParser.ARRAY_END_TOKEN;
    }
