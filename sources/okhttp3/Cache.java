...
public final class Cache implements Closeable, Flushable {
    ...
    public final void update$okhttp(Response response, Response response2) {
        ...
        Intrinsics.checkNotNullParameter(response2, Logger.NETWORK);
    ...
    public final File m1392deprecated_directory() {
        return this.cache.getDirectory();
    }
        ...
        private final Set<String> varyFields(Headers headers) {
            ...
            for (int i = 0; i < size; i++) {
                if (StringsKt.equals(HttpHeaders.VARY, headers.name(i), true)) {
                    ...
                    for (String str : StringsKt.split$default((CharSequence) value, new char[]{ASCIIPropertyListParser.ARRAY_ITEM_DELIMITER_TOKEN}, false, 0, 6, (Object) null)) {
                        if (str != null) {
