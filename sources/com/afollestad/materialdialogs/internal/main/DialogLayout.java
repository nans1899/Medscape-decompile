...
public final class DialogLayout extends FrameLayout {
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.debugMode) {
            ...
            verticalLine$default(this, canvas2, -16776961, DimensKt.dp(this, 24), 0.0f, 4, (Object) null);
            horizontalLine$default(this, canvas2, -16776961, DimensKt.dp(this, 24), 0.0f, 4, (Object) null);
            verticalLine$default(this, canvas, -16776961, ((float) getMeasuredWidth()) - DimensKt.dp(this, 24), 0.0f, 4, (Object) null);
            DialogTitleLayout dialogTitleLayout = this.titleLayout;
            if (dialogTitleLayout == null) {
                Intrinsics.throwUninitializedPropertyAccessException("titleLayout");
            }
            ...
            if (DialogActionButtonLayoutKt.shouldBeVisible(this.buttonsLayout)) {
                ...
                if (dialogActionButtonLayout == null || !dialogActionButtonLayout.getStackButtons$core()) {
                    ...
                    if (dialogActionButtonLayout2 != null) {
                        ...
                        horizontalLine$default(this, canvas3, -16776961, measuredHeight - DimensKt.dp(this, 8), 0.0f, 4, (Object) null);
                        return;
                    }
                    return;
                }
                ...
                for (DialogActionButton left : dialogActionButtonLayout7.getVisibleButtons()) {
                    ...
                    box(canvas, -16711681, 0.4f, (float) left.getLeft(), ((float) getMeasuredWidth()) - DimensKt.dp(this, 8), f2, dp);
