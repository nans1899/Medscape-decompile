...
public final class FilterSelectionFragment$$special$$inlined$navArgs$1 extends Lambda implements Function0<Bundle> {
    final /* synthetic */ Fragment $this_navArgs;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FilterSelectionFragment$$special$$inlined$navArgs$1(Fragment fragment) {
        super(0);
