...
final class LandingFeedViewModel$loadFeed$1<I, O> implements Function<FeedListing<FeedDataItem>, LiveData<NetworkState>> {
    public static final LandingFeedViewModel$loadFeed$1 INSTANCE = new LandingFeedViewModel$loadFeed$1();

    LandingFeedViewModel$loadFeed$1() {
    }
