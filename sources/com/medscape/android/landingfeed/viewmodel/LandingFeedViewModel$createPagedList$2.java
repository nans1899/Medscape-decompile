...
final class LandingFeedViewModel$createPagedList$2 extends Lambda implements Function0<Unit> {
    final /* synthetic */ FeedDataSourceFactory $factory;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LandingFeedViewModel$createPagedList$2(FeedDataSourceFactory feedDataSourceFactory) {
        super(0);
