...
final class DrugManufacturerViewHolder$bindFallback$1 implements View.OnClickListener {
    final /* synthetic */ Context $context;
    final /* synthetic */ SharethroughFallback $fallback;

    DrugManufacturerViewHolder$bindFallback$1(Context context, SharethroughFallback sharethroughFallback) {
    ...
    public final void onClick(View view) {
        ...
        if (context != null) {
            if (this.$fallback.getDeepLink() != null) {
                ...
                if (StringsKt.contains$default((CharSequence) deepLink, (CharSequence) DeepLinkConstants.HEALTH_DIRECTORY, false, 2, (Object) null)) {
