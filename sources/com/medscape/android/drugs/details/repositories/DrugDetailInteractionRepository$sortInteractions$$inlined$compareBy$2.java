...
public final class DrugDetailInteractionRepository$sortInteractions$$inlined$compareBy$2<T> implements Comparator<T> {
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(Integer.valueOf(((InteractionListItem) t).getStrength()), Integer.valueOf(((InteractionListItem) t2).getStrength()));
    }
}
