    ...
    public static class Builder {
        ...
        public CustomToolTipWithAnimation build() throws IllegalArgumentException {
            ...
            if (this.backgroundColor == 0) {
                this.backgroundColor = CustomToolTipUtil.getColor(this.context, R.color.medscapedarkblue);
            }
            if (this.textColor == 0) {
                this.textColor = CustomToolTipUtil.getColor(this.context, R.color.white);
            }
            if (this.contentView == null) {
                TextView textView = new TextView(this.context);
                CustomToolTipUtil.setTextAppearance(textView, 2132017767);
                textView.setBackgroundColor(this.backgroundColor);
                textView.setTextColor(this.textColor);
                this.contentView = textView;
            }
            if (this.arrowColor == 0) {
                this.arrowColor = CustomToolTipUtil.getColor(this.context, R.color.medscapedarkblue);
            }
            if (this.margin < 0.0f) {
                this.margin = 0.0f;
            }
