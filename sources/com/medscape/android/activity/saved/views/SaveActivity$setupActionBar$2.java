...
final class SaveActivity$setupActionBar$2 implements View.OnClickListener {
    final /* synthetic */ SaveActivity this$0;

    SaveActivity$setupActionBar$2(SaveActivity saveActivity) {
        this.this$0 = saveActivity;
    }

    public final void onClick(View view) {
        if (!SaveActivity.access$getSaveViewModel$p(this.this$0).getEditModeActive()) {
            this.this$0.getDelete().setImageDrawable(ResourcesCompat.getDrawable(this.this$0.getResources(), R.drawable.consult_check, (Resources.Theme) null));
            SaveActivity.access$getSaveViewModel$p(this.this$0).setEditModeActive(true);
        ...
        PagerAdapter adapter2 = SaveActivity.access$getViewPager$p(this.this$0).getAdapter();
        if (adapter2 != null) {
