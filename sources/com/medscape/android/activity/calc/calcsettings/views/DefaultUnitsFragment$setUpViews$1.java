...
final class DefaultUnitsFragment$setUpViews$1 implements View.OnClickListener {
    final /* synthetic */ DBUser $dbUser;
    final /* synthetic */ DefaultUnitsFragment this$0;

    DefaultUnitsFragment$setUpViews$1(DefaultUnitsFragment defaultUnitsFragment, DBUser dBUser) {
    ...
    public final void onClick(View view) {
        ...
        dBUser.setDefaultUnits(Unit.UnitType.convertTypeToString(Unit.UnitType.SI_UNITS));
        this.$dbUser.update();
