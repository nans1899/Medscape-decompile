...
public class CreatorCollector {
    ...
    protected static final String[] TYPE_DESCS = {"default", "String", "int", Settings.LONGITUDE_KEY, "double", "boolean", MethodDelegation.ImplementationDelegate.FIELD_NAME_PREFIX, "property-based"};
