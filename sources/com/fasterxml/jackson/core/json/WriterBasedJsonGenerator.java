...
public final class WriterBasedJsonGenerator extends JsonGeneratorImpl {
    ...
    public void _writeFieldName(String str, boolean z) throws IOException {
        ...
        if (z) {
            ...
            cArr[i] = ASCIIPropertyListParser.ARRAY_ITEM_DELIMITER_TOKEN;
        }
    ...
    public void writeStartObject() throws IOException, JsonGenerationException {
        ...
        int i = this._outputTail;
        this._outputTail = i + 1;
        cArr[i] = ASCIIPropertyListParser.DICTIONARY_BEGIN_TOKEN;
    }
    ...
    public void writeEndObject() throws IOException, JsonGenerationException {
        ...
        if (this._cfgPrettyPrinter != null) {
            ...
            int i = this._outputTail;
            this._outputTail = i + 1;
            cArr[i] = ASCIIPropertyListParser.DICTIONARY_END_TOKEN;
        }
        this._writeContext = this._writeContext.clearAndGetParent();
    }
    ...
    public void writeBoolean(boolean z) throws IOException {
        ...
        if (z) {
            ...
            cArr[i6] = 'l';
            int i7 = i6 + 1;
            cArr[i7] = Advice.OffsetMapping.ForOrigin.Renderer.ForJavaSignature.SYMBOL;
            i = i7 + 1;
            cArr[i] = 'e';
        }
        this._outputTail = i + 1;
