...
public class DefaultContentCardsViewBindingHandler implements IContentCardsViewBindingHandler {
    ...
    public BaseContentCardView getContentCardsViewFromCache(Context context, CardType cardType) {
        ...
        if (!this.mContentCardViewCache.containsKey(cardType)) {
            int i = AnonymousClass1.$SwitchMap$com$appboy$enums$CardType[cardType.ordinal()];
            if (i == 1) {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0033:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.appboy.ui.contentcards.handlers.DefaultContentCardsViewBindingHandler.AnonymousClass1.<clinit>():void");
        }
    }
}
