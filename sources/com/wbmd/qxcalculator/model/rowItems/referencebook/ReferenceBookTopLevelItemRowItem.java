...
public class ReferenceBookTopLevelItemRowItem extends QxRecyclerViewRowItem {
    ...
    public void onBindData(RecyclerView.ViewHolder viewHolder, int i, QxIndexPath qxIndexPath, QxRecyclerViewRowItem.RowPosition rowPosition, QxRecyclerViewAdapter qxRecyclerViewAdapter) {
        ...
        if (i2 != i3) {
            ...
            ViewCompat.setPaddingRelative(referenceBookItemViewHolder.container, defaultPaddingWidth + (this.indentOverride * indentWidth), referenceBookItemViewHolder.container.getPaddingTop(), ViewCompat.getPaddingEnd(referenceBookItemViewHolder.container), referenceBookItemViewHolder.container.getPaddingBottom());
        }
