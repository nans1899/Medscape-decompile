...
public class DBAnswerChoiceDao extends AbstractDao<DBAnswerChoice, Long> {
    ...
    public static class Properties {
        ...
        public static final Property QuestionId = new Property(6, Long.class, "questionId", false, "QUESTION_ID");
    ...
    public static void createTable(SQLiteDatabase sQLiteDatabase, boolean z) {
        ...
        sQLiteDatabase.execSQL("CREATE TABLE " + str + "'DBANSWER_CHOICE' ('_id' INTEGER PRIMARY KEY ,'IDENTIFIER' TEXT,'TITLE_PRIMARY' TEXT,'TITLE_SECONDARY' TEXT,'ANSWER_FACTOR' REAL,'UNIT_INDEPENDENT' INTEGER,'QUESTION_ID' INTEGER);");
    }
    ...
    public void bindValues(SQLiteStatement sQLiteStatement, DBAnswerChoice dBAnswerChoice) {
        ...
        if (questionId != null) {
            sQLiteStatement.bindLong(7, questionId.longValue());
        }
    }
    ...
    public DBAnswerChoice readEntity(Cursor cursor, int i) {
        ...
        int i8 = i + 6;
        return new DBAnswerChoice(valueOf, string, string2, string3, valueOf2, bool, cursor.isNull(i8) ? null : Long.valueOf(cursor.getLong(i8)));
    }
