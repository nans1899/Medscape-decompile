...
public class DBContentItemDao extends AbstractDao<DBContentItem, Long> {
    ...
    public static class Properties {
        public static final Property CalculatorId = new Property(21, Long.class, "calculatorId", false, "CALCULATOR_ID");
        public static final Property CommonFileId = new Property(26, Long.class, "commonFileId", false, "COMMON_FILE_ID");
        public static final Property DebugType = new Property(9, Integer.class, "debugType", false, "DEBUG_TYPE");
        public static final Property DefinitionId = new Property(22, Long.class, "definitionId", false, "DEFINITION_ID");
        ...
        public static final Property FileSourceId = new Property(23, Long.class, "fileSourceId", false, "FILE_SOURCE_ID");
        ...
        public static final Property ItemFileZipId = new Property(25, Long.class, "itemFileZipId", false, "ITEM_FILE_ZIP_ID");
        ...
        public static final Property ReferenceBookId = new Property(24, Long.class, "referenceBookId", false, "REFERENCE_BOOK_ID");
        ...
        public static final Property UserId = new Property(20, Long.class, Constants.USER_TAG_KEY_USER_ID, false, "USER_ID");
    }
    ...
    public DBContentItem readEntity(Cursor cursor, int i) {
        ...
        int i28 = i + 26;
        return new DBContentItem(valueOf, string, string2, string3, string4, valueOf2, valueOf3, string5, valueOf4, valueOf5, string6, string7, bool, bool2, string8, valueOf6, bool3, bool4, bool5, bool6, valueOf7, valueOf8, valueOf9, valueOf10, valueOf11, valueOf12, cursor2.isNull(i28) ? null : Long.valueOf(cursor2.getLong(i28)));
    }
    ...
    public void readEntity(Cursor cursor, DBContentItem dBContentItem, int i) {
        ...
        int i22 = i + 20;
        dBContentItem.setUserId(cursor.isNull(i22) ? null : Long.valueOf(cursor.getLong(i22)));
        int i23 = i + 21;
        dBContentItem.setCalculatorId(cursor.isNull(i23) ? null : Long.valueOf(cursor.getLong(i23)));
        int i24 = i + 22;
        dBContentItem.setDefinitionId(cursor.isNull(i24) ? null : Long.valueOf(cursor.getLong(i24)));
        int i25 = i + 23;
        dBContentItem.setFileSourceId(cursor.isNull(i25) ? null : Long.valueOf(cursor.getLong(i25)));
        int i26 = i + 24;
        dBContentItem.setReferenceBookId(cursor.isNull(i26) ? null : Long.valueOf(cursor.getLong(i26)));
        int i27 = i + 25;
        dBContentItem.setItemFileZipId(cursor.isNull(i27) ? null : Long.valueOf(cursor.getLong(i27)));
        int i28 = i + 26;
        if (!cursor.isNull(i28)) {
            l = Long.valueOf(cursor.getLong(i28));
        }
