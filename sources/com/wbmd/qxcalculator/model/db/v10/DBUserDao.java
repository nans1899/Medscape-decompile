...
public class DBUserDao extends AbstractDao<DBUser, Long> {
    ...
    public static class Properties {
        ...
        public static final Property AdSettingId = new Property(48, Long.class, "adSettingId", false, "AD_SETTING_ID");
        ...
        public static final Property IdentifierForLegacyUser = new Property(43, Long.class, "identifierForLegacyUser", false, "IDENTIFIER_FOR_LEGACY_USER");
        public static final Property InstitutionId = new Property(44, Long.class, "institutionId", false, "INSTITUTION_ID");
        ...
        public static final Property LocationId = new Property(45, Long.class, "locationId", false, "LOCATION_ID");
        ...
        public static final Property ProfessionId = new Property(46, Long.class, "professionId", false, "PROFESSION_ID");
        ...
        public static final Property SpecialtyId = new Property(47, Long.class, FeedCache.FeedCaches.SPECIALITY_ID, false, "SPECIALTY_ID");
    ...
    public void bindValues(SQLiteStatement sQLiteStatement, DBUser dBUser) {
        ...
        Long identifierForLegacyUser = dBUser.getIdentifierForLegacyUser();
        if (identifierForLegacyUser != null) {
            sQLiteStatement.bindLong(44, identifierForLegacyUser.longValue());
        }
        Long institutionId = dBUser.getInstitutionId();
        if (institutionId != null) {
            sQLiteStatement.bindLong(45, institutionId.longValue());
        }
        Long locationId = dBUser.getLocationId();
        if (locationId != null) {
            sQLiteStatement.bindLong(46, locationId.longValue());
        }
        Long professionId = dBUser.getProfessionId();
        if (professionId != null) {
            sQLiteStatement.bindLong(47, professionId.longValue());
        }
        Long specialtyId = dBUser.getSpecialtyId();
        if (specialtyId != null) {
            sQLiteStatement.bindLong(48, specialtyId.longValue());
        }
        Long adSettingId = dBUser.getAdSettingId();
        if (adSettingId != null) {
            sQLiteStatement.bindLong(49, adSettingId.longValue());
        }
    }
    ...
    public void readEntity(Cursor cursor, DBUser dBUser, int i) {
        ...
        int i45 = i + 43;
        dBUser.setIdentifierForLegacyUser(cursor.isNull(i45) ? null : Long.valueOf(cursor.getLong(i45)));
        int i46 = i + 44;
        dBUser.setInstitutionId(cursor.isNull(i46) ? null : Long.valueOf(cursor.getLong(i46)));
        int i47 = i + 45;
        dBUser.setLocationId(cursor.isNull(i47) ? null : Long.valueOf(cursor.getLong(i47)));
        int i48 = i + 46;
        dBUser.setProfessionId(cursor.isNull(i48) ? null : Long.valueOf(cursor.getLong(i48)));
        int i49 = i + 47;
        dBUser.setSpecialtyId(cursor.isNull(i49) ? null : Long.valueOf(cursor.getLong(i49)));
        int i50 = i + 48;
        if (!cursor.isNull(i50)) {
            l = Long.valueOf(cursor.getLong(i50));
        }
