...
public class DBFilterDao extends AbstractDao<DBFilter, Long> {
    ...
    private Query<DBFilter> dBPromotion_FiltersQuery;
    private Query<DBFilter> dBRestriction_FiltersQuery;
    ...
    public static class Properties {
        ...
        public static final Property PromotionId = new Property(6, Long.class, "promotionId", false, "PROMOTION_ID");
        public static final Property RestrictionId = new Property(5, Long.class, "restrictionId", false, "RESTRICTION_ID");
    ...
    public static void createTable(SQLiteDatabase sQLiteDatabase, boolean z) {
        ...
        sQLiteDatabase.execSQL("CREATE TABLE " + str + "'DBFILTER' ('_id' INTEGER PRIMARY KEY ,'IDENTIFIER' TEXT,'TYPE' TEXT,'CONTENT_ITEM_ID' INTEGER,'FEATURED_CONTENT_AD_ID' INTEGER,'RESTRICTION_ID' INTEGER,'PROMOTION_ID' INTEGER);");
    }
    ...
    public void bindValues(SQLiteStatement sQLiteStatement, DBFilter dBFilter) {
        ...
        Long restrictionId = dBFilter.getRestrictionId();
        if (restrictionId != null) {
            sQLiteStatement.bindLong(6, restrictionId.longValue());
        }
        Long promotionId = dBFilter.getPromotionId();
        if (promotionId != null) {
            sQLiteStatement.bindLong(7, promotionId.longValue());
        }
    }
    ...
    public DBFilter readEntity(Cursor cursor, int i) {
        ...
        int i7 = i + 5;
        int i8 = i + 6;
        return new DBFilter(valueOf, string, string2, valueOf2, valueOf3, cursor.isNull(i7) ? null : Long.valueOf(cursor.getLong(i7)), cursor.isNull(i8) ? null : Long.valueOf(cursor.getLong(i8)));
    }
    ...
    public void readEntity(Cursor cursor, DBFilter dBFilter, int i) {
        ...
        int i6 = i + 4;
        dBFilter.setFeaturedContentAdId(cursor.isNull(i6) ? null : Long.valueOf(cursor.getLong(i6)));
        int i7 = i + 5;
        dBFilter.setRestrictionId(cursor.isNull(i7) ? null : Long.valueOf(cursor.getLong(i7)));
        int i8 = i + 6;
        if (!cursor.isNull(i8)) {
            l = Long.valueOf(cursor.getLong(i8));
        }
        dBFilter.setPromotionId(l);
    }
    ...
    public List<DBFilter> _queryDBRestriction_Filters(Long l) {
        synchronized (this) {
            if (this.dBRestriction_FiltersQuery == null) {
                QueryBuilder queryBuilder = queryBuilder();
                queryBuilder.where(Properties.RestrictionId.eq((Object) null), new WhereCondition[0]);
                this.dBRestriction_FiltersQuery = queryBuilder.build();
            }
        }
        Query<DBFilter> forCurrentThread = this.dBRestriction_FiltersQuery.forCurrentThread();
        forCurrentThread.setParameter(0, (Object) l);
        return forCurrentThread.list();
    }

    public List<DBFilter> _queryDBPromotion_Filters(Long l) {
        synchronized (this) {
            if (this.dBPromotion_FiltersQuery == null) {
                QueryBuilder queryBuilder = queryBuilder();
                queryBuilder.where(Properties.PromotionId.eq((Object) null), new WhereCondition[0]);
                this.dBPromotion_FiltersQuery = queryBuilder.build();
            }
        }
        Query<DBFilter> forCurrentThread = this.dBPromotion_FiltersQuery.forCurrentThread();
        forCurrentThread.setParameter(0, (Object) l);
        return forCurrentThread.list();
    }
}
