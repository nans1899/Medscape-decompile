...
public class DBQuestionDao extends AbstractDao<DBQuestion, Long> {
    ...
    public static class Properties {
        public static final Property CalculatorId = new Property(13, Long.class, "calculatorId", false, "CALCULATOR_ID");
    ...
    public void bindValues(SQLiteStatement sQLiteStatement, DBQuestion dBQuestion) {
        ...
        if (calculatorId != null) {
            sQLiteStatement.bindLong(14, calculatorId.longValue());
        }
    }
    ...
    public DBQuestion readEntity(Cursor cursor, int i) {
        ...
        int i14 = i + 12;
        int i15 = i + 13;
        return new DBQuestion(cursor2.isNull(i2) ? null : Long.valueOf(cursor2.getLong(i2)), cursor2.isNull(i3) ? null : cursor2.getString(i3), cursor2.isNull(i4) ? null : Long.valueOf(cursor2.getLong(i4)), cursor2.isNull(i5) ? null : Integer.valueOf(cursor2.getInt(i5)), cursor2.isNull(i6) ? null : cursor2.getString(i6), cursor2.isNull(i7) ? null : cursor2.getString(i7), cursor2.isNull(i8) ? null : cursor2.getString(i8), cursor2.isNull(i9) ? null : cursor2.getString(i9), cursor2.isNull(i10) ? null : cursor2.getString(i10), cursor2.isNull(i11) ? null : cursor2.getString(i11), cursor2.isNull(i12) ? null : cursor2.getString(i12), cursor2.isNull(i13) ? null : cursor2.getString(i13), cursor2.isNull(i14) ? null : Double.valueOf(cursor2.getDouble(i14)), cursor2.isNull(i15) ? null : Long.valueOf(cursor2.getLong(i15)));
    }
