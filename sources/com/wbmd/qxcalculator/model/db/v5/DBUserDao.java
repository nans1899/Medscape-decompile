...
public class DBUserDao extends AbstractDao<DBUser, Long> {
    ...
    public void bindValues(SQLiteStatement sQLiteStatement, DBUser dBUser) {
        ...
        if (shouldSendRemovePnTokenRequest != null) {
            if (!shouldSendRemovePnTokenRequest.booleanValue()) {
                j = 0;
            }
    ...
    public DBUser readEntity(Cursor cursor, int i) {
        ...
        if (cursor2.isNull(i34)) {
            ...
            if (cursor2.getShort(i34) == 0) {
                z = false;
            }
            bool12 = Boolean.valueOf(z);
        }
        int i35 = i + 33;
        Long valueOf6 = cursor2.isNull(i35) ? null : Long.valueOf(cursor2.getLong(i35));
        int i36 = i + 34;
        Long valueOf7 = cursor2.isNull(i36) ? null : Long.valueOf(cursor2.getLong(i36));
        int i37 = i + 35;
        Long valueOf8 = cursor2.isNull(i37) ? null : Long.valueOf(cursor2.getLong(i37));
        int i38 = i + 36;
        Long valueOf9 = cursor2.isNull(i38) ? null : Long.valueOf(cursor2.getLong(i38));
        int i39 = i + 37;
        return new DBUser(valueOf, string, string2, string3, string4, string5, string6, bool, bool2, string7, string8, string9, string10, string11, valueOf2, string12, string13, string14, string15, bool3, bool4, valueOf3, valueOf4, string16, bool5, bool6, valueOf5, bool7, bool8, bool9, bool10, bool11, bool12, valueOf6, valueOf7, valueOf8, valueOf9, cursor2.isNull(i39) ? null : Long.valueOf(cursor2.getLong(i39)));
    }
    ...
    public void readEntity(Cursor cursor, DBUser dBUser, int i) {
        ...
        if (!cursor.isNull(i39)) {
            l = Long.valueOf(cursor.getLong(i39));
        }
