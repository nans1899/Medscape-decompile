...
public class DaoSession extends AbstractDaoSession {
    ...
    public DaoSession(SQLiteDatabase sQLiteDatabase, IdentityScopeType identityScopeType, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig> map) {
        ...
        DaoConfig clone31 = map.get(DBCommonFileDao.class).clone();
        this.dBCommonFileDaoConfig = clone31;
        clone31.initIdentityScope(identityScopeType);
        DaoConfig clone32 = map.get(DBReferenceBookDao.class).clone();
        this.dBReferenceBookDaoConfig = clone32;
        clone32.initIdentityScope(identityScopeType);
        DaoConfig clone33 = map.get(DBReferenceBookSectionDao.class).clone();
        this.dBReferenceBookSectionDaoConfig = clone33;
        clone33.initIdentityScope(identityScopeType);
        DaoConfig clone34 = map.get(DBReferenceBookSectionItemDao.class).clone();
        this.dBReferenceBookSectionItemDaoConfig = clone34;
        clone34.initIdentityScope(identityScopeType);
        DaoConfig clone35 = map.get(DBPushNotificationDao.class).clone();
        this.dBPushNotificationDaoConfig = clone35;
