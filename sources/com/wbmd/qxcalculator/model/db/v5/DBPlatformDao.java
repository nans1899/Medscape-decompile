...
public class DBPlatformDao extends AbstractDao<DBPlatform, Long> {
    ...
    public static void createTable(SQLiteDatabase sQLiteDatabase, boolean z) {
        ...
        sQLiteDatabase.execSQL("CREATE TABLE " + str + "'DBPLATFORM' ('_id' INTEGER PRIMARY KEY ,'IDENTIFIER' TEXT,'OS' TEXT,'DEVICE_TYPE' TEXT,'MIN_VERSION' TEXT,'MAX_VERSION' TEXT,'CONTENT_ITEM_ID' INTEGER,'FEATURED_CONTENT_AD_ID' INTEGER,'RESTRICTION_ID' INTEGER);");
    }
    ...
    public DBPlatform readEntity(Cursor cursor, int i) {
        ...
        int i9 = i + 7;
        int i10 = i + 8;
        return new DBPlatform(valueOf, string, string2, string3, string4, string5, valueOf2, cursor.isNull(i9) ? null : Long.valueOf(cursor.getLong(i9)), cursor.isNull(i10) ? null : Long.valueOf(cursor.getLong(i10)));
    }
