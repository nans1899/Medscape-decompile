...
public class DBContentItemDao extends AbstractDao<DBContentItem, Long> {
    ...
    public static class Properties {
        public static final Property CalculatorId = new Property(22, Long.class, "calculatorId", false, "CALCULATOR_ID");
        public static final Property CommonFileId = new Property(27, Long.class, "commonFileId", false, "COMMON_FILE_ID");
        ...
        public static final Property DefinitionId = new Property(23, Long.class, "definitionId", false, "DEFINITION_ID");
        ...
        public static final Property FileSourceId = new Property(24, Long.class, "fileSourceId", false, "FILE_SOURCE_ID");
        ...
        public static final Property ItemFileZipId = new Property(26, Long.class, "itemFileZipId", false, "ITEM_FILE_ZIP_ID");
        ...
        public static final Property ReferenceBookId = new Property(25, Long.class, "referenceBookId", false, "REFERENCE_BOOK_ID");
        ...
        public static final Property UserId = new Property(21, Long.class, Constants.USER_TAG_KEY_USER_ID, false, "USER_ID");
    }
    ...
    public DBContentItem readEntity(Cursor cursor, int i) {
        ...
        int i23 = i + 21;
        Long valueOf8 = cursor2.isNull(i23) ? null : Long.valueOf(cursor2.getLong(i23));
        int i24 = i + 22;
        Long valueOf9 = cursor2.isNull(i24) ? null : Long.valueOf(cursor2.getLong(i24));
        int i25 = i + 23;
        Long valueOf10 = cursor2.isNull(i25) ? null : Long.valueOf(cursor2.getLong(i25));
        int i26 = i + 24;
        Long valueOf11 = cursor2.isNull(i26) ? null : Long.valueOf(cursor2.getLong(i26));
        int i27 = i + 25;
        Long valueOf12 = cursor2.isNull(i27) ? null : Long.valueOf(cursor2.getLong(i27));
        int i28 = i + 26;
        Long valueOf13 = cursor2.isNull(i28) ? null : Long.valueOf(cursor2.getLong(i28));
        int i29 = i + 27;
        return new DBContentItem(valueOf, string, string2, string3, string4, valueOf2, valueOf3, string5, valueOf4, valueOf5, string6, string7, bool, bool2, string8, valueOf6, bool3, bool4, bool5, bool6, valueOf7, valueOf8, valueOf9, valueOf10, valueOf11, valueOf12, valueOf13, cursor2.isNull(i29) ? null : Long.valueOf(cursor2.getLong(i29)));
    }
    ...
    public void readEntity(Cursor cursor, DBContentItem dBContentItem, int i) {
        ...
        int i23 = i + 21;
        dBContentItem.setUserId(cursor.isNull(i23) ? null : Long.valueOf(cursor.getLong(i23)));
        int i24 = i + 22;
        dBContentItem.setCalculatorId(cursor.isNull(i24) ? null : Long.valueOf(cursor.getLong(i24)));
        int i25 = i + 23;
        dBContentItem.setDefinitionId(cursor.isNull(i25) ? null : Long.valueOf(cursor.getLong(i25)));
        int i26 = i + 24;
        dBContentItem.setFileSourceId(cursor.isNull(i26) ? null : Long.valueOf(cursor.getLong(i26)));
        int i27 = i + 25;
        dBContentItem.setReferenceBookId(cursor.isNull(i27) ? null : Long.valueOf(cursor.getLong(i27)));
        int i28 = i + 26;
        dBContentItem.setItemFileZipId(cursor.isNull(i28) ? null : Long.valueOf(cursor.getLong(i28)));
        int i29 = i + 27;
        if (!cursor.isNull(i29)) {
            l = Long.valueOf(cursor.getLong(i29));
        }
    ...
    public String getSelectDeep() {
        if (this.selectDeep == null) {
            ...
            sb.append(ASCIIPropertyListParser.ARRAY_ITEM_DELIMITER_TOKEN);
            SqlUtils.appendColumns(sb, "T3", this.daoSession.getDBReferenceBookDao().getAllColumns());
            sb.append(ASCIIPropertyListParser.ARRAY_ITEM_DELIMITER_TOKEN);
            SqlUtils.appendColumns(sb, "T4", this.daoSession.getDBItemFileZipDao().getAllColumns());
            sb.append(ASCIIPropertyListParser.ARRAY_ITEM_DELIMITER_TOKEN);
            SqlUtils.appendColumns(sb, "T5", this.daoSession.getDBCommonFileDao().getAllColumns());
            ...
            sb.append(" LEFT JOIN DBREFERENCE_BOOK T3 ON T.'REFERENCE_BOOK_ID'=T3.'_id'");
            sb.append(" LEFT JOIN DBITEM_FILE_ZIP T4 ON T.'ITEM_FILE_ZIP_ID'=T4.'_id'");
            sb.append(" LEFT JOIN DBCOMMON_FILE T5 ON T.'COMMON_FILE_ID'=T5.'_id'");
            sb.append(' ');
    ...
    public DBContentItem loadCurrentDeep(Cursor cursor, boolean z) {
        ...
        dBContentItem.setReferenceBook((DBReferenceBook) loadCurrentOther(this.daoSession.getDBReferenceBookDao(), cursor, length4));
        int length5 = length4 + this.daoSession.getDBReferenceBookDao().getAllColumns().length;
        dBContentItem.setItemFileZip((DBItemFileZip) loadCurrentOther(this.daoSession.getDBItemFileZipDao(), cursor, length5));
        dBContentItem.setCommonFile((DBCommonFile) loadCurrentOther(this.daoSession.getDBCommonFileDao(), cursor, length5 + this.daoSession.getDBItemFileZipDao().getAllColumns().length));
