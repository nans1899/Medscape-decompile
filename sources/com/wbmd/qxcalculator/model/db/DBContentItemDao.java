...
public class DBContentItemDao extends AbstractDao<DBContentItem, Long> {
    ...
    public static class Properties {
        ...
        public static final Property UserId = new Property(26, Long.class, Constants.USER_TAG_KEY_USER_ID, false, "USER_ID");
    }
    ...
    public void bindValues(SQLiteStatement sQLiteStatement, DBContentItem dBContentItem) {
        ...
        String leadSpecialty = dBContentItem.getLeadSpecialty();
        if (leadSpecialty != null) {
            sQLiteStatement.bindString(24, leadSpecialty);
        }
        String leadConcept = dBContentItem.getLeadConcept();
        if (leadConcept != null) {
            sQLiteStatement.bindString(25, leadConcept);
        }
        String allSpecialty = dBContentItem.getAllSpecialty();
        if (allSpecialty != null) {
            sQLiteStatement.bindString(26, allSpecialty);
        }
    ...
    public DBContentItem readEntity(Cursor cursor, int i) {
        ...
        int i28 = i + 26;
        Long valueOf8 = cursor2.isNull(i28) ? null : Long.valueOf(cursor2.getLong(i28));
        int i29 = i + 27;
        Long valueOf9 = cursor2.isNull(i29) ? null : Long.valueOf(cursor2.getLong(i29));
        int i30 = i + 28;
        Long valueOf10 = cursor2.isNull(i30) ? null : Long.valueOf(cursor2.getLong(i30));
        int i31 = i + 29;
        Long valueOf11 = cursor2.isNull(i31) ? null : Long.valueOf(cursor2.getLong(i31));
        int i32 = i + 30;
        Long valueOf12 = cursor2.isNull(i32) ? null : Long.valueOf(cursor2.getLong(i32));
        int i33 = i + 31;
        Long valueOf13 = cursor2.isNull(i33) ? null : Long.valueOf(cursor2.getLong(i33));
        int i34 = i + 32;
        Long valueOf14 = cursor2.isNull(i34) ? null : Long.valueOf(cursor2.getLong(i34));
        int i35 = i + 33;
        return new DBContentItem(valueOf, string, string2, string3, string4, valueOf2, valueOf3, string5, valueOf4, valueOf5, string6, string7, bool, bool2, string8, valueOf6, bool3, bool4, bool5, bool6, valueOf7, string9, bool7, string10, string11, string12, valueOf8, valueOf9, valueOf10, valueOf11, valueOf12, valueOf13, valueOf14, cursor2.isNull(i35) ? null : Long.valueOf(cursor2.getLong(i35)));
    }
    ...
    public void readEntity(Cursor cursor, DBContentItem dBContentItem, int i) {
        ...
        int i25 = i + 23;
        dBContentItem.setLeadSpecialty(cursor.isNull(i25) ? null : cursor.getString(i25));
        int i26 = i + 24;
        dBContentItem.setLeadConcept(cursor.isNull(i26) ? null : cursor.getString(i26));
        int i27 = i + 25;
        dBContentItem.setAllSpecialty(cursor.isNull(i27) ? null : cursor.getString(i27));
        int i28 = i + 26;
        dBContentItem.setUserId(cursor.isNull(i28) ? null : Long.valueOf(cursor.getLong(i28)));
        int i29 = i + 27;
        dBContentItem.setCalculatorId(cursor.isNull(i29) ? null : Long.valueOf(cursor.getLong(i29)));
        int i30 = i + 28;
        dBContentItem.setDefinitionId(cursor.isNull(i30) ? null : Long.valueOf(cursor.getLong(i30)));
        int i31 = i + 29;
        dBContentItem.setFileSourceId(cursor.isNull(i31) ? null : Long.valueOf(cursor.getLong(i31)));
        int i32 = i + 30;
        dBContentItem.setSplashPageId(cursor.isNull(i32) ? null : Long.valueOf(cursor.getLong(i32)));
        int i33 = i + 31;
        dBContentItem.setReferenceBookId(cursor.isNull(i33) ? null : Long.valueOf(cursor.getLong(i33)));
        int i34 = i + 32;
        dBContentItem.setItemFileZipId(cursor.isNull(i34) ? null : Long.valueOf(cursor.getLong(i34)));
        int i35 = i + 33;
