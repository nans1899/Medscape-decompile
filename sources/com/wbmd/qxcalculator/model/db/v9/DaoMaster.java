...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void dropAllTables(SQLiteDatabase sQLiteDatabase, boolean z) {
        ...
        DBRestrictionDao.dropTable(sQLiteDatabase, z);
        ...
        DBSplashPageDao.dropTable(sQLiteDatabase, z);
        ...
        DBConsentUserDao.dropTable(sQLiteDatabase, z);
        DBConsentLocationDao.dropTable(sQLiteDatabase, z);
        DBPromotionDao.dropTable(sQLiteDatabase, z);
    }
