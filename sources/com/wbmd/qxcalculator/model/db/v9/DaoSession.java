...
public class DaoSession extends AbstractDaoSession {
    ...
    private final DBConsentLocationDao dBConsentLocationDao = new DBConsentLocationDao(this.dBConsentLocationDaoConfig, this);
    private final DaoConfig dBConsentLocationDaoConfig;
    private final DBConsentUserDao dBConsentUserDao = new DBConsentUserDao(this.dBConsentUserDaoConfig, this);
    ...
    private final DBPromotionDao dBPromotionDao = new DBPromotionDao(this.dBPromotionDaoConfig, this);
    private final DaoConfig dBPromotionDaoConfig;
    private final DBPushNotificationDao dBPushNotificationDao = new DBPushNotificationDao(this.dBPushNotificationDaoConfig, this);
    ...
    private final DBRestrictionDao dBRestrictionDao = new DBRestrictionDao(this.dBRestrictionDaoConfig, this);
    ...
    private final DBSplashPageDao dBSplashPageDao = new DBSplashPageDao(this.dBSplashPageDaoConfig, this);
    private final DaoConfig dBSplashPageDaoConfig;
    ...
    public DaoSession(SQLiteDatabase sQLiteDatabase, IdentityScopeType identityScopeType, Map<Class<? extends AbstractDao<?, ?>>, DaoConfig> map) {
        ...
        DaoConfig clone20 = map.get(DBRestrictionDao.class).clone();
        this.dBRestrictionDaoConfig = clone20;
        clone20.initIdentityScope(identityScopeType);
        DaoConfig clone21 = map.get(DBCalculatorDao.class).clone();
        this.dBCalculatorDaoConfig = clone21;
        clone21.initIdentityScope(identityScopeType);
        DaoConfig clone22 = map.get(DBQuestionDao.class).clone();
        this.dBQuestionDaoConfig = clone22;
        clone22.initIdentityScope(identityScopeType);
        DaoConfig clone23 = map.get(DBAnswerChoiceDao.class).clone();
        this.dBAnswerChoiceDaoConfig = clone23;
        clone23.initIdentityScope(identityScopeType);
        DaoConfig clone24 = map.get(DBUnitDao.class).clone();
        this.dBUnitDaoConfig = clone24;
        clone24.initIdentityScope(identityScopeType);
        DaoConfig clone25 = map.get(DBResultDao.class).clone();
        this.dBResultDaoConfig = clone25;
        clone25.initIdentityScope(identityScopeType);
        DaoConfig clone26 = map.get(DBErrorCheckDao.class).clone();
        this.dBErrorCheckDaoConfig = clone26;
        clone26.initIdentityScope(identityScopeType);
        DaoConfig clone27 = map.get(DBLinkedCalculatorItemDao.class).clone();
        this.dBLinkedCalculatorItemDaoConfig = clone27;
        clone27.initIdentityScope(identityScopeType);
        DaoConfig clone28 = map.get(DBDefinitionDao.class).clone();
        this.dBDefinitionDaoConfig = clone28;
        clone28.initIdentityScope(identityScopeType);
        DaoConfig clone29 = map.get(DBDefinitionSectionDao.class).clone();
        this.dBDefinitionSectionDaoConfig = clone29;
        clone29.initIdentityScope(identityScopeType);
        DaoConfig clone30 = map.get(DBFileSourceDao.class).clone();
        this.dBFileSourceDaoConfig = clone30;
        clone30.initIdentityScope(identityScopeType);
        DaoConfig clone31 = map.get(DBSplashPageDao.class).clone();
        this.dBSplashPageDaoConfig = clone31;
        clone31.initIdentityScope(identityScopeType);
        DaoConfig clone32 = map.get(DBCommonFileDao.class).clone();
        this.dBCommonFileDaoConfig = clone32;
        clone32.initIdentityScope(identityScopeType);
        DaoConfig clone33 = map.get(DBReferenceBookDao.class).clone();
        this.dBReferenceBookDaoConfig = clone33;
        clone33.initIdentityScope(identityScopeType);
        DaoConfig clone34 = map.get(DBReferenceBookSectionDao.class).clone();
        this.dBReferenceBookSectionDaoConfig = clone34;
        clone34.initIdentityScope(identityScopeType);
        DaoConfig clone35 = map.get(DBReferenceBookSectionItemDao.class).clone();
        this.dBReferenceBookSectionItemDaoConfig = clone35;
        clone35.initIdentityScope(identityScopeType);
        DaoConfig clone36 = map.get(DBPushNotificationDao.class).clone();
        this.dBPushNotificationDaoConfig = clone36;
        clone36.initIdentityScope(identityScopeType);
        DaoConfig clone37 = map.get(DBConsentUserDao.class).clone();
        this.dBConsentUserDaoConfig = clone37;
        clone37.initIdentityScope(identityScopeType);
        DaoConfig clone38 = map.get(DBConsentLocationDao.class).clone();
        this.dBConsentLocationDaoConfig = clone38;
        clone38.initIdentityScope(identityScopeType);
        DaoConfig clone39 = map.get(DBPromotionDao.class).clone();
        this.dBPromotionDaoConfig = clone39;
        ...
        registerDao(DBSplashPage.class, this.dBSplashPageDao);
        ...
        registerDao(DBConsentUser.class, this.dBConsentUserDao);
        registerDao(DBConsentLocation.class, this.dBConsentLocationDao);
    ...
    public void clear() {
        ...
        this.dBSplashPageDaoConfig.getIdentityScope().clear();
        ...
        this.dBConsentUserDaoConfig.getIdentityScope().clear();
        this.dBConsentLocationDaoConfig.getIdentityScope().clear();
    ...
    public DBSplashPageDao getDBSplashPageDao() {
        return this.dBSplashPageDao;
    }
