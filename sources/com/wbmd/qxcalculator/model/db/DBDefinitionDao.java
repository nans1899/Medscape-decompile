...
public class DBDefinitionDao extends AbstractDao<DBDefinition, Long> {
    ...
    public DBDefinitionDao(DaoConfig daoConfig, DaoSession daoSession2) {
    ...
    public static void createTable(SQLiteDatabase sQLiteDatabase, boolean z) {
        ...
        sQLiteDatabase.execSQL("CREATE TABLE " + str + "'DBDEFINITION' ('_id' INTEGER PRIMARY KEY ,'IDENTIFIER' TEXT);");
    }
    ...
    public void bindValues(SQLiteStatement sQLiteStatement, DBDefinition dBDefinition) {
        ...
        String identifier = dBDefinition.getIdentifier();
        if (identifier != null) {
    ...
    /* access modifiers changed from: protected */
    public void attachEntity(DBDefinition dBDefinition) {
        super.attachEntity(dBDefinition);
        dBDefinition.__setDaoSession(this.daoSession);
    }
    ...
    public DBDefinition readEntity(Cursor cursor, int i) {
        ...
        return new DBDefinition(valueOf, str);
    }
    ...
    public void readEntity(Cursor cursor, DBDefinition dBDefinition, int i) {
        ...
        dBDefinition.setIdentifier(str);
    }
