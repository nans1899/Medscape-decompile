...
public class DBFeaturedContentAdDao extends AbstractDao<DBFeaturedContentAd, Long> {
    ...
    public static void createTable(SQLiteDatabase sQLiteDatabase, boolean z) {
        ...
        sQLiteDatabase.execSQL("CREATE TABLE " + str + "'DBFEATURED_CONTENT_AD' ('_id' INTEGER PRIMARY KEY ,'IDENTIFIER' TEXT,'NAME' TEXT,'DESCRIPTION' TEXT,'DISCLAIMER' TEXT,'FOOTER' TEXT,'IMAGE_SOURCE' TEXT,'BACKGROUND_COLOR' TEXT,'DISPLAY_FREQUENCY' REAL,'CONTENT_ITEM_ID' INTEGER);");
    }
    ...
    public DBFeaturedContentAd readEntity(Cursor cursor, int i) {
        ...
        int i10 = i + 8;
        int i11 = i + 9;
        return new DBFeaturedContentAd(cursor.isNull(i2) ? null : Long.valueOf(cursor.getLong(i2)), cursor.isNull(i3) ? null : cursor.getString(i3), cursor.isNull(i4) ? null : cursor.getString(i4), cursor.isNull(i5) ? null : cursor.getString(i5), cursor.isNull(i6) ? null : cursor.getString(i6), cursor.isNull(i7) ? null : cursor.getString(i7), cursor.isNull(i8) ? null : cursor.getString(i8), cursor.isNull(i9) ? null : cursor.getString(i9), cursor.isNull(i10) ? null : Double.valueOf(cursor.getDouble(i10)), cursor.isNull(i11) ? null : Long.valueOf(cursor.getLong(i11)));
    }
