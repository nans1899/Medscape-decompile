...
public class DBFilterDao extends AbstractDao<DBFilter, Long> {
    ...
    public static void createTable(SQLiteDatabase sQLiteDatabase, boolean z) {
        ...
        sQLiteDatabase.execSQL("CREATE TABLE " + str + "'DBFILTER' ('_id' INTEGER PRIMARY KEY ,'IDENTIFIER' TEXT,'TYPE' TEXT,'CONTENT_ITEM_ID' INTEGER,'FEATURED_CONTENT_AD_ID' INTEGER,'RESTRICTION_ID' INTEGER);");
    }
    ...
    public DBFilter readEntity(Cursor cursor, int i) {
        ...
        int i6 = i + 4;
        int i7 = i + 5;
        return new DBFilter(valueOf, string, string2, valueOf2, cursor.isNull(i6) ? null : Long.valueOf(cursor.getLong(i6)), cursor.isNull(i7) ? null : Long.valueOf(cursor.getLong(i7)));
    }
