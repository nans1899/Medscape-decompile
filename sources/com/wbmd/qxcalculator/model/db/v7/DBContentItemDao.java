...
public class DBContentItemDao extends AbstractDao<DBContentItem, Long> {
    ...
    public static class Properties {
        public static final Property CalculatorId = new Property(24, Long.class, "calculatorId", false, "CALCULATOR_ID");
        public static final Property CommonFileId = new Property(30, Long.class, "commonFileId", false, "COMMON_FILE_ID");
        ...
        public static final Property DefinitionId = new Property(25, Long.class, "definitionId", false, "DEFINITION_ID");
        ...
        public static final Property FileSourceId = new Property(26, Long.class, "fileSourceId", false, "FILE_SOURCE_ID");
        ...
        public static final Property ItemFileZipId = new Property(29, Long.class, "itemFileZipId", false, "ITEM_FILE_ZIP_ID");
        ...
        public static final Property ReferenceBookId = new Property(28, Long.class, "referenceBookId", false, "REFERENCE_BOOK_ID");
        ...
        public static final Property SplashPageId = new Property(27, Long.class, "splashPageId", false, "SPLASH_PAGE_ID");
        ...
        public static final Property UserId = new Property(23, Long.class, Constants.USER_TAG_KEY_USER_ID, false, "USER_ID");
    }
    ...
    public void bindValues(SQLiteStatement sQLiteStatement, DBContentItem dBContentItem) {
        ...
        if (showAds != null) {
            sQLiteStatement.bindLong(20, showAds.booleanValue() ? 1 : 0);
        }
        ...
        Boolean isRecent = dBContentItem.getIsRecent();
        if (isRecent != null) {
            if (!isRecent.booleanValue()) {
                j = 0;
            }
            sQLiteStatement.bindLong(23, j);
        }
        Long userId = dBContentItem.getUserId();
        if (userId != null) {
            sQLiteStatement.bindLong(24, userId.longValue());
        }
        Long calculatorId = dBContentItem.getCalculatorId();
        if (calculatorId != null) {
            sQLiteStatement.bindLong(25, calculatorId.longValue());
        }
        Long definitionId = dBContentItem.getDefinitionId();
        if (definitionId != null) {
            sQLiteStatement.bindLong(26, definitionId.longValue());
        }
        Long fileSourceId = dBContentItem.getFileSourceId();
        if (fileSourceId != null) {
            sQLiteStatement.bindLong(27, fileSourceId.longValue());
        }
        Long splashPageId = dBContentItem.getSplashPageId();
        if (splashPageId != null) {
            sQLiteStatement.bindLong(28, splashPageId.longValue());
        }
        Long referenceBookId = dBContentItem.getReferenceBookId();
        if (referenceBookId != null) {
            sQLiteStatement.bindLong(29, referenceBookId.longValue());
        }
        Long itemFileZipId = dBContentItem.getItemFileZipId();
        if (itemFileZipId != null) {
            sQLiteStatement.bindLong(30, itemFileZipId.longValue());
        }
        Long commonFileId = dBContentItem.getCommonFileId();
        if (commonFileId != null) {
            sQLiteStatement.bindLong(31, commonFileId.longValue());
        }
    }
    ...
    public DBContentItem readEntity(Cursor cursor, int i) {
        ...
        if (cursor2.isNull(i21)) {
            ...
            bool6 = Boolean.valueOf(cursor2.getShort(i21) != 0);
        }
        int i22 = i + 20;
        ...
        if (cursor2.isNull(i24)) {
            ...
            if (cursor2.getShort(i24) == 0) {
                z = false;
            }
            bool7 = Boolean.valueOf(z);
        }
        int i25 = i + 23;
        Long valueOf8 = cursor2.isNull(i25) ? null : Long.valueOf(cursor2.getLong(i25));
        int i26 = i + 24;
        Long valueOf9 = cursor2.isNull(i26) ? null : Long.valueOf(cursor2.getLong(i26));
        int i27 = i + 25;
        Long valueOf10 = cursor2.isNull(i27) ? null : Long.valueOf(cursor2.getLong(i27));
        int i28 = i + 26;
        Long valueOf11 = cursor2.isNull(i28) ? null : Long.valueOf(cursor2.getLong(i28));
        int i29 = i + 27;
        Long valueOf12 = cursor2.isNull(i29) ? null : Long.valueOf(cursor2.getLong(i29));
        int i30 = i + 28;
        Long valueOf13 = cursor2.isNull(i30) ? null : Long.valueOf(cursor2.getLong(i30));
        int i31 = i + 29;
        Long valueOf14 = cursor2.isNull(i31) ? null : Long.valueOf(cursor2.getLong(i31));
        int i32 = i + 30;
        return new DBContentItem(valueOf, string, string2, string3, string4, valueOf2, valueOf3, string5, valueOf4, valueOf5, string6, string7, bool, bool2, string8, valueOf6, bool3, bool4, bool5, bool6, valueOf7, string9, bool7, valueOf8, valueOf9, valueOf10, valueOf11, valueOf12, valueOf13, valueOf14, cursor2.isNull(i32) ? null : Long.valueOf(cursor2.getLong(i32)));
    }
    ...
    public void readEntity(Cursor cursor, DBContentItem dBContentItem, int i) {
        ...
        if (cursor.isNull(i21)) {
            ...
            bool6 = Boolean.valueOf(cursor.getShort(i21) != 0);
        }
        ...
        if (cursor.isNull(i24)) {
            ...
            if (cursor.getShort(i24) == 0) {
                z = false;
            }
            bool7 = Boolean.valueOf(z);
        }
        dBContentItem.setIsRecent(bool7);
        int i25 = i + 23;
        dBContentItem.setUserId(cursor.isNull(i25) ? null : Long.valueOf(cursor.getLong(i25)));
        int i26 = i + 24;
        dBContentItem.setCalculatorId(cursor.isNull(i26) ? null : Long.valueOf(cursor.getLong(i26)));
        int i27 = i + 25;
        dBContentItem.setDefinitionId(cursor.isNull(i27) ? null : Long.valueOf(cursor.getLong(i27)));
        int i28 = i + 26;
        dBContentItem.setFileSourceId(cursor.isNull(i28) ? null : Long.valueOf(cursor.getLong(i28)));
        int i29 = i + 27;
        dBContentItem.setSplashPageId(cursor.isNull(i29) ? null : Long.valueOf(cursor.getLong(i29)));
        int i30 = i + 28;
        dBContentItem.setReferenceBookId(cursor.isNull(i30) ? null : Long.valueOf(cursor.getLong(i30)));
        int i31 = i + 29;
        dBContentItem.setItemFileZipId(cursor.isNull(i31) ? null : Long.valueOf(cursor.getLong(i31)));
        int i32 = i + 30;
        if (!cursor.isNull(i32)) {
            l = Long.valueOf(cursor.getLong(i32));
        }
