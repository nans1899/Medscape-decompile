...
public class SystemBarTintManager {
    ...
    private void setupStatusBarView(Context context, ViewGroup viewGroup) {
        ...
        if (this.mNavBarAvailable) {
            this.mConfig.isNavigationAtBottom();
        }
    ...
    public static class SystemBarConfig {
        ...
        private boolean hasNavBar(Context context) {
            ...
            if (AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(SystemBarTintManager.sNavBarOverride)) {
                return false;
            }
            if (AppEventsConstants.EVENT_PARAM_VALUE_NO.equals(SystemBarTintManager.sNavBarOverride)) {
                return true;
            }
            return z;
        }
        ...
        public int getPixelInsetTop(boolean z) {
            int i = 0;
            int i2 = (this.mTranslucentStatusBar || Build.VERSION.SDK_INT >= 21) ? this.mStatusBarHeight : 0;
            if (z) {
