...
public class EventDBDao extends AbstractDao<EventDB, Long> {
    ...
    public static void createTable(SQLiteDatabase sQLiteDatabase, boolean z) {
        ...
        sQLiteDatabase.execSQL("CREATE TABLE " + str + "'EVENT_DB' ('_id' INTEGER PRIMARY KEY ,'APP_NAME' TEXT,'APP_VERSION' TEXT,'DEVICE' TEXT,'DURATION' INTEGER,'EMAIL_HASH' TEXT,'EVENT_TYPE_ID' INTEGER,'INSTITUTION_ID' INTEGER,'LOCATION_ID' INTEGER,'OBJECT_ID' INTEGER,'PROFESSION_ID' INTEGER,'SPECIALTY_ID' INTEGER,'USER_ID' INTEGER,'TIME_STAMP' INTEGER,'CATEGORY' TEXT,'LABEL' TEXT,'URL' TEXT,'CAMPAIGN_AD_ID' INTEGER,'SOURCE' TEXT);");
    }
    ...
    public void bindValues(SQLiteStatement sQLiteStatement, EventDB eventDB) {
        ...
        String source = eventDB.getSource();
        if (source != null) {
    ...
    public EventDB readEntity(Cursor cursor, int i) {
        ...
        int i19 = i + 17;
        Long valueOf10 = cursor2.isNull(i19) ? null : Long.valueOf(cursor2.getLong(i19));
        int i20 = i + 18;
        return new EventDB(valueOf, string, string2, string3, valueOf2, string4, valueOf3, valueOf4, valueOf5, valueOf6, valueOf7, valueOf8, l, date, string5, string6, string7, valueOf10, cursor2.isNull(i20) ? null : cursor2.getString(i20));
    }
    ...
    public void readEntity(Cursor cursor, EventDB eventDB, int i) {
        ...
        int i19 = i + 17;
        eventDB.setCampaignAdId(cursor.isNull(i19) ? null : Long.valueOf(cursor.getLong(i19)));
        int i20 = i + 18;
        if (!cursor.isNull(i20)) {
            str = cursor.getString(i20);
        }
        eventDB.setSource(str);
    }
