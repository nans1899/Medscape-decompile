    ...
    public void resumeAction(Action action) {
        ...
        if (quickMemoryCacheCheck != null) {
            ...
            if (this.loggingEnabled) {
                ...
                Utils.log("Main", OmnitureData.LINK_NAME_TRACKER_COMPLETE, logId, "from " + LoadedFrom.MEMORY);
                return;
            }
            return;
        }
    ...
    private void deliverAction(Bitmap bitmap, LoadedFrom loadedFrom, Action action, Exception exc) {
        if (!action.isCancelled()) {
            ...
            if (bitmap == null) {
                ...
                if (this.loggingEnabled) {
                    String logId = action.request.logId();
                    Utils.log("Main", OmnitureData.LINK_NAME_TRACKER_COMPLETE, logId, "from " + loadedFrom);
                }
            } else {
