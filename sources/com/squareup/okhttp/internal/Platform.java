...
public class Platform {
    ...
    static <T> T readFieldOrNull(Object obj, Class<T> cls, String str) {
        ...
        if (str.equals(MethodDelegation.ImplementationDelegate.FIELD_NAME_PREFIX) || (readFieldOrNull = readFieldOrNull(obj, Object.class, MethodDelegation.ImplementationDelegate.FIELD_NAME_PREFIX)) == null) {
            return null;
        }
