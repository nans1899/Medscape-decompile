...
public final class Service extends GeneratedMessageLite<Service, Builder> implements ServiceOrBuilder {
    ...
    public int getSerializedSize() {
        ...
        for (int i2 = 0; i2 < this.apis_.size(); i2++) {
            computeStringSize += CodedOutputStream.computeMessageSize(3, (MessageLite) this.apis_.get(i2));
        }
        for (int i3 = 0; i3 < this.types_.size(); i3++) {
            computeStringSize += CodedOutputStream.computeMessageSize(4, (MessageLite) this.types_.get(i3));
        }
        for (int i4 = 0; i4 < this.enums_.size(); i4++) {
            computeStringSize += CodedOutputStream.computeMessageSize(5, (MessageLite) this.enums_.get(i4));
        }
        if (this.documentation_ != null) {
        ...
        for (int i5 = 0; i5 < this.endpoints_.size(); i5++) {
            computeStringSize += CodedOutputStream.computeMessageSize(18, (MessageLite) this.endpoints_.get(i5));
        }
        if (this.configVersion_ != null) {
        ...
        if (!this.producerProjectId_.isEmpty()) {
            computeStringSize += CodedOutputStream.computeStringSize(22, getProducerProjectId());
        }
        for (int i6 = 0; i6 < this.logs_.size(); i6++) {
            computeStringSize += CodedOutputStream.computeMessageSize(23, (MessageLite) this.logs_.get(i6));
        }
        for (int i7 = 0; i7 < this.metrics_.size(); i7++) {
            computeStringSize += CodedOutputStream.computeMessageSize(24, (MessageLite) this.metrics_.get(i7));
        }
        for (int i8 = 0; i8 < this.monitoredResources_.size(); i8++) {
            computeStringSize += CodedOutputStream.computeMessageSize(25, (MessageLite) this.monitoredResources_.get(i8));
        }
        if (this.billing_ != null) {
        ...
        if (!this.id_.isEmpty()) {
            computeStringSize += CodedOutputStream.computeStringSize(33, getId());
        }
        if (this.sourceInfo_ != null) {
            computeStringSize += CodedOutputStream.computeMessageSize(37, getSourceInfo());
        }
        if (this.experimental_ != null) {
            computeStringSize += CodedOutputStream.computeMessageSize(101, getExperimental());
        }
                        ...
                        switch (readTag) {
                            ...
                            case 50:
                                ...
                                if (builder == null) {
                                    ...
                                    builder.mergeFrom(documentation);
                            ...
                            case 90:
                                ...
                                if (builder5 == null) {
                                    ...
                                    builder5.mergeFrom(authentication);
                            ...
                            case 162:
                                ...
                                if (builder8 == null) {
                                    ...
                                    builder8.mergeFrom(uInt32Value);
                            ...
                            case 226:
                                ...
                                if (builder12 == null) {
                                    ...
                                    builder12.mergeFrom(monitoring);
                            ...
                            case AdvertisementType.BRANDED_AS_CONTENT:
                                ...
                                if (builder13 == null) {
                                    ...
                                    builder13.mergeFrom(systemParameters);
                            ...
                            case 298:
                                ...
                                if (builder14 == null) {
                                    ...
                                    builder14.mergeFrom(sourceInfo);
                                    this.sourceInfo_ = (SourceInfo) builder14.buildPartial();
                                    break;
                                }
                            case ContentDeliveryAdvertisementCapability.LINEAR_7DAY:
                                Experimental.Builder builder15 = this.experimental_ != null ? (Experimental.Builder) this.experimental_.toBuilder() : null;
                                Experimental experimental = (Experimental) codedInputStream.readMessage(Experimental.parser(), extensionRegistryLite);
                                this.experimental_ = experimental;
                                if (builder15 == null) {
                                    break;
                                } else {
                                    builder15.mergeFrom(experimental);
