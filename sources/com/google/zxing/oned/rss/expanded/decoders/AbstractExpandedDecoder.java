...
public abstract class AbstractExpandedDecoder {
    ...
    public static AbstractExpandedDecoder createDecoder(BitArray bitArray) {
        ...
        switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(bitArray, 1, 7)) {
            case 56:
                return new AI013x0x1xDecoder(bitArray, "310", UserProfile.PHYS_ASST_ID);
            case 57:
                return new AI013x0x1xDecoder(bitArray, "320", UserProfile.PHYS_ASST_ID);
            case 58:
                return new AI013x0x1xDecoder(bitArray, "310", "13");
            case 59:
                return new AI013x0x1xDecoder(bitArray, "320", "13");
            case 60:
                return new AI013x0x1xDecoder(bitArray, "310", UserProfile.OHCP_ID);
            case 61:
                return new AI013x0x1xDecoder(bitArray, "320", UserProfile.OHCP_ID);
            case 62:
