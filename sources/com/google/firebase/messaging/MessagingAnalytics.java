...
public class MessagingAnalytics {
    ...
    public static boolean shouldUploadScionMetrics(Intent intent) {
        ...
        return AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(intent.getStringExtra(Constants.AnalyticsKeys.ENABLED));
    }
    ...
    private static void setUserPropertyIfRequired(Intent intent) {
        if (intent != null) {
            if (AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(intent.getStringExtra(Constants.AnalyticsKeys.TRACK_CONVERSIONS))) {
                ...
                if (analyticsConnector != null) {
                    ...
                    bundle.putString("source", PlatformConstants.FIREBASE_SERVICE);
    ...
    static int getPriority(Intent intent) {
        ...
        if (stringExtra == null) {
            if (AppEventsConstants.EVENT_PARAM_VALUE_YES.equals(intent.getStringExtra(Constants.MessagePayloadKeys.PRIORITY_REDUCED_V19))) {
                return 2;
            }
