...
class RequestDeduplicator {
    ...
    public synchronized com.google.android.gms.tasks.Task<com.google.firebase.iid.InstanceIdResult> getOrStartGetTokenRequest(java.lang.String r4, java.lang.String r5, com.google.firebase.iid.RequestDeduplicator.GetTokenRequest r6) {
        /*
            r3 = this;
            monitor-enter(r3)
            android.util.Pair r0 = new android.util.Pair     // Catch:{ all -> 0x0081 }
            r0.<init>(r4, r5)     // Catch:{ all -> 0x0081 }
            java.util.Map<android.util.Pair<java.lang.String, java.lang.String>, com.google.android.gms.tasks.Task<com.google.firebase.iid.InstanceIdResult>> r4 = r3.getTokenRequests     // Catch:{ all -> 0x0081 }
        ...
        L_0x006b:
            com.google.android.gms.tasks.Task r4 = r6.start()     // Catch:{ all -> 0x0081 }
            java.util.concurrent.Executor r5 = r3.executor     // Catch:{ all -> 0x0081 }
            com.google.firebase.iid.RequestDeduplicator$$Lambda$0 r6 = new com.google.firebase.iid.RequestDeduplicator$$Lambda$0     // Catch:{ all -> 0x0081 }
            r6.<init>(r3, r0)     // Catch:{ all -> 0x0081 }
            com.google.android.gms.tasks.Task r4 = r4.continueWithTask(r5, r6)     // Catch:{ all -> 0x0081 }
            java.util.Map<android.util.Pair<java.lang.String, java.lang.String>, com.google.android.gms.tasks.Task<com.google.firebase.iid.InstanceIdResult>> r5 = r3.getTokenRequests     // Catch:{ all -> 0x0081 }
