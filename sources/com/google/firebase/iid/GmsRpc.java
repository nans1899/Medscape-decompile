...
public class GmsRpc {
    ...
    public GmsRpc(FirebaseApp firebaseApp, Metadata metadata2, UserAgentPublisher userAgentPublisher2, HeartBeatInfo heartBeatInfo, FirebaseInstallationsApi firebaseInstallationsApi) {
        this(firebaseApp, metadata2, new Rpc(firebaseApp.getApplicationContext()), userAgentPublisher2, heartBeatInfo, firebaseInstallationsApi);
    }
    ...
    public Task<?> deleteToken(String str, String str2, String str3) {
        ...
        bundle.putString(Constants.OMNITURE_MLINK_UNSAVE, AppEventsConstants.EVENT_PARAM_VALUE_YES);
        return extractResponseWhenComplete(startRpc(str, str2, str3, bundle));
    }

    public Task<?> deleteInstanceId(String str) {
        Bundle bundle = new Bundle();
        bundle.putString("iid-operation", Constants.OMNITURE_MLINK_UNSAVE);
        bundle.putString(Constants.OMNITURE_MLINK_UNSAVE, AppEventsConstants.EVENT_PARAM_VALUE_YES);
