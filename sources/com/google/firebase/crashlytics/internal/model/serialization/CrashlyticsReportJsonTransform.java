        ...
        while (jsonReader.hasNext()) {
            ...
            switch (nextName.hashCode()) {
                ...
                case -1335157162:
                    ...
                    break;
                case -1291329255:
                    if (nextName.equals(OmnitureConstants.CHANNEL)) {
                        c = 9;
                        break;
                    }
                    break;
                case 3556:
                    if (nextName.equals(AdParameterKeys.OS)) {
                        c = 7;
                        break;
                    }
                    break;
                case 96801:
                    if (nextName.equals(AdParameterKeys.SECTION_ID)) {
                        c = 6;
                        break;
                    }
                    break;
