...
public final class MediaType {
    ...
    public static final MediaType PDF = createConstant(APPLICATION_TYPE, ContentParser.PDF);
    ...
    public static final MediaType ZIP = createConstant(APPLICATION_TYPE, Settings.ZIP);
    @LazyInit
