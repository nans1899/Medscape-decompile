...
final class GeneralRange<T> implements Serializable {
    ...
    public String toString() {
        ...
        sb.append(":");
        sb.append(this.lowerBoundType == BoundType.CLOSED ? TypePool.Default.LazyTypeDescription.GenericTypeToken.COMPONENT_TYPE_PATH : ASCIIPropertyListParser.ARRAY_BEGIN_TOKEN);
        sb.append(this.hasLowerBound ? this.lowerEndpoint : "-∞");
        sb.append(ASCIIPropertyListParser.ARRAY_ITEM_DELIMITER_TOKEN);
        sb.append(this.hasUpperBound ? this.upperEndpoint : "∞");
        sb.append(this.upperBoundType == BoundType.CLOSED ? ']' : ASCIIPropertyListParser.ARRAY_END_TOKEN);
        return sb.toString();
    }
