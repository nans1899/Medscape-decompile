...
public final class LongMath {
    ...
    public static long gcd(long j, long j2) {
        MathPreconditions.checkNonNegative(Constants.APPBOY_PUSH_CONTENT_KEY, j);
    ...
    public static long factorial(int i) {
        MathPreconditions.checkNonNegative(Constants.APPBOY_PUSH_CUSTOM_NOTIFICATION_ID, i);
    ...
    public static boolean isPrime(long j) {
        int i = (j > 2 ? 1 : (j == 2 ? 0 : -1));
        if (i < 0) {
            MathPreconditions.checkNonNegative(Constants.APPBOY_PUSH_CUSTOM_NOTIFICATION_ID, j);
            return false;
