...
public class EventBus {
    ...
    static final class LoggingHandler implements SubscriberExceptionHandler {
        ...
        private static String message(SubscriberExceptionContext subscriberExceptionContext) {
            ...
            return "Exception thrown by subscriber method " + subscriberMethod.getName() + ASCIIPropertyListParser.ARRAY_BEGIN_TOKEN + subscriberMethod.getParameterTypes()[0].getName() + ASCIIPropertyListParser.ARRAY_END_TOKEN + " on subscriber " + subscriberExceptionContext.getSubscriber() + " when dispatching event: " + subscriberExceptionContext.getEvent();
        }
    }
}
