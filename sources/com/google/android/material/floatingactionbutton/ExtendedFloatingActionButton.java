...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static final Property<View, Float> HEIGHT = new Property<View, Float>(Float.class, GraphicParser.XML_ATRIBUTE_VALUE_HEIGHT) {
    ...
    static final Property<View, Float> WIDTH = new Property<View, Float>(Float.class, GraphicParser.XML_ATTRIBUTE_VALUE_WIDTH) {
        public void set(View view, Float f) {
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues(GraphicParser.XML_ATTRIBUTE_VALUE_WIDTH)) {
                PropertyValuesHolder[] propertyValues = currentMotionSpec.getPropertyValues(GraphicParser.XML_ATTRIBUTE_VALUE_WIDTH);
                propertyValues[0].setFloatValues(new float[]{(float) ExtendedFloatingActionButton.this.getWidth(), (float) this.size.getWidth()});
                currentMotionSpec.setPropertyValues(GraphicParser.XML_ATTRIBUTE_VALUE_WIDTH, propertyValues);
            }
            if (currentMotionSpec.hasPropertyValues(GraphicParser.XML_ATRIBUTE_VALUE_HEIGHT)) {
                PropertyValuesHolder[] propertyValues2 = currentMotionSpec.getPropertyValues(GraphicParser.XML_ATRIBUTE_VALUE_HEIGHT);
                propertyValues2[0].setFloatValues(new float[]{(float) ExtendedFloatingActionButton.this.getHeight(), (float) this.size.getHeight()});
                currentMotionSpec.setPropertyValues(GraphicParser.XML_ATRIBUTE_VALUE_HEIGHT, propertyValues2);
            }
