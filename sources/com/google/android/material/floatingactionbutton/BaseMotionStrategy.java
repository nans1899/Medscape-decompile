...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec2) {
        ...
        if (motionSpec2.hasPropertyValues(GraphicParser.XML_ATTRIBUTE_VALUE_WIDTH)) {
            arrayList.add(motionSpec2.getAnimator(GraphicParser.XML_ATTRIBUTE_VALUE_WIDTH, this.fab, ExtendedFloatingActionButton.WIDTH));
        }
        if (motionSpec2.hasPropertyValues(GraphicParser.XML_ATRIBUTE_VALUE_HEIGHT)) {
            arrayList.add(motionSpec2.getAnimator(GraphicParser.XML_ATRIBUTE_VALUE_HEIGHT, this.fab, ExtendedFloatingActionButton.HEIGHT));
        }
