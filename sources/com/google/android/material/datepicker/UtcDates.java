...
class UtcDates {
    ...
    static String getTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) {
        ...
        return localizedPattern.replaceAll(Constants.APPBOY_PUSH_NOTIFICATION_SOUND_DEFAULT_VALUE, resources.getString(R.string.mtrl_picker_text_input_day_abbr)).replaceAll("M", resources.getString(R.string.mtrl_picker_text_input_month_abbr)).replaceAll("y", resources.getString(R.string.mtrl_picker_text_input_year_abbr));
    }
    ...
    private static String removeYearFromDateFormatPattern(String str) {
        ...
        return str.replace(str.substring(findCharactersInDateFormatPattern(str, str2, -1, findCharactersInDateFormatPattern) + 1, findCharactersInDateFormatPattern2), MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).trim();
    }
