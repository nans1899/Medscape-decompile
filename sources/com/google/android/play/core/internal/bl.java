...
public final class bl {
    ...
    public static <R, P0> R a(Class cls, String str, Class<R> cls2, Class<P0> cls3, P0 p0) {
        try {
            ...
            throw new bm(String.format("Failed to invoke static method %s on type %s", new Object[]{str, cls}), e);
        }
    }
    ...
    public static <R, P0> R a(Object obj, String str, Class<R> cls, Class<P0> cls2, P0 p0) {
        try {
            ...
            throw new bm(String.format("Failed to invoke method %s on an object of type %s", new Object[]{str, obj.getClass()}), e);
        }
    }
    ...
    private static Method a(Class<?> cls, String str, Class<?>... clsArr) {
        ...
        throw new bm(String.format("Could not find a method named %s with parameters %s in type %s", new Object[]{str, Arrays.asList(clsArr), cls}));
    }
    ...
    public static <T> bk b(Object obj, String str, Class<T> cls) {
        return new bk(obj, b(obj, str), cls, (byte[]) null);
    }
    ...
    private static Field b(Object obj, String str) {
        ...
        throw new bm(String.format("Failed to find a field named %s on an object of instance %s", new Object[]{str, obj.getClass().getName()}));
    }
}
