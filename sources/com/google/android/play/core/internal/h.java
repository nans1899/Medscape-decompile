...
public final class h {
    ...
    private static java.security.cert.X509Certificate[] a(java.nio.ByteBuffer r22, java.util.Map<java.lang.Integer, byte[]> r23, java.security.cert.CertificateFactory r24) throws java.lang.SecurityException, java.io.IOException {
        ...
        L_0x0153:
            ...
            int r5 = r5 + r15
            java.nio.ByteBuffer r8 = d(r1)     // Catch:{ IOException -> 0x0180, BufferUnderflowException -> 0x017e }
            ...
            byte[] r6 = e(r8)     // Catch:{ IOException -> 0x0180, BufferUnderflowException -> 0x017e }
            goto L_0x0153
        L_0x0176:
    ...
    public static X509Certificate[][] a(String str) throws e, SecurityException, IOException {
        ...
        try {
            ...
            if (a != null) {
                ...
                } else if (b(byteBuffer2) + a2 != longValue) {
                                            ...
                                            while (slice.hasRemaining()) {
                                                ...
                                                if (slice.remaining() >= i) {
                                                    ...
                                                    if (i4 > slice.remaining()) {
                                                        ...
                                                        X509Certificate[][] a3 = a(randomAccessFile.getChannel(), new d(b(slice, i4 - 4), longValue2, a2, longValue, byteBuffer2));
