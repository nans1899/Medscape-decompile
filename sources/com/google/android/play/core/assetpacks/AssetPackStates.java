...
public abstract class AssetPackStates {
    ...
    public static AssetPackStates a(Bundle bundle, cb cbVar) {
        return a(bundle, cbVar, (List<String>) new ArrayList());
    }

    public static AssetPackStates a(Bundle bundle, cb cbVar, az azVar) {
        return a(bundle, cbVar, new ArrayList(), azVar);
    }

    public static AssetPackStates a(Bundle bundle, cb cbVar, List<String> list) {
        return a(bundle, cbVar, list, ba.a);
    }

    private static AssetPackStates a(Bundle bundle, cb cbVar, List<String> list, az azVar) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            hashMap.put(str, AssetPackState.a(bundle, str, cbVar, azVar));
        }
        int size2 = list.size();
