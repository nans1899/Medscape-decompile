...
final class ab extends com.google.android.play.core.internal.ab {
    ...
    ab(ar arVar, i iVar, List list, i iVar2, List list2) {
        super(iVar);
        this.d = arVar;
        this.a = list;
        this.b = iVar2;
    ...
    public final void a() {
        ...
        try {
            ...
            Bundle c2 = ar.c();
            ar arVar = this.d;
            ((s) this.d.e.b()).a(a3, (List<Bundle>) a2, c2, (u) new aq(arVar, this.b, arVar.d, this.c));
        } catch (RemoteException e) {
            ar.a.a((Throwable) e, "startDownload(%s)", this.a);
