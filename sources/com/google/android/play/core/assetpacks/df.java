...
final class df {
    private static final aa a = new aa("MergeSliceTaskHandler");
    private final bb b;
    ...
    public final void a(de deVar) {
        File b2 = this.b.b(deVar.k, deVar.a, deVar.b, deVar.c);
        if (b2.exists()) {
            ...
            throw new by(String.format("Cannot find verified files for slice %s.", new Object[]{deVar.c}), deVar.j);
        }
    }
}
