...
final class az {
    ...
    public az(Context context) {
        ...
        if (bt.a(context)) {
            this.a = new ak(v.a(context), b, "SplitInstallService", c, ah.a);
        }
    }
    ...
    public final Task<List<SplitInstallSessionState>> a() {
        ...
        i iVar = new i();
        this.a.a((ab) new ao(this, iVar, iVar));
        return iVar.a();
    }
    ...
    public final Task<SplitInstallSessionState> a(int i) {
        ...
        i iVar = new i();
        this.a.a((ab) new an(this, iVar, i, iVar));
        return iVar.a();
    }
    ...
    public final Task<Integer> a(Collection<String> collection, Collection<String> collection2) {
        ...
        i iVar = new i();
        this.a.a((ab) new ai(this, iVar, collection, collection2, iVar));
        return iVar.a();
    }
    ...
    public final Task<Void> a(List<String> list) {
        ...
        i iVar = new i();
        this.a.a((ab) new aj(this, iVar, list, iVar));
        return iVar.a();
    }
    ...
    public final Task<Void> b(int i) {
        ...
        i iVar = new i();
        this.a.a((ab) new ap(this, iVar, i, iVar));
        return iVar.a();
    }
    ...
    public final Task<Void> b(List<String> list) {
        ...
        i iVar = new i();
        this.a.a((ab) new ak(this, iVar, list, iVar));
        return iVar.a();
    }
    ...
    public final Task<Void> c(List<String> list) {
        ...
        i iVar = new i();
        this.a.a((ab) new al(this, iVar, list, iVar));
        return iVar.a();
    }
    ...
    public final Task<Void> d(List<String> list) {
        ...
        i iVar = new i();
        this.a.a((ab) new am(this, iVar, list, iVar));
        return iVar.a();
    }
}
