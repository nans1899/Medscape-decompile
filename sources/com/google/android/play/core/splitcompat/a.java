...
final class a {
    ...
    static final synchronized void b(Context context, Set<File> set) {
        synchronized (a.class) {
            ...
            for (File path : set) {
                int intValue = ((Integer) bl.a((Object) assets, "addAssetPath", Integer.class, String.class, path.getPath())).intValue();
    ...
    public final synchronized boolean a(android.content.Context r5, java.util.Set<java.lang.String> r6) {
        ...
        L_0x0022:
            ...
            com.google.android.play.core.splitcompat.e r3 = r4.a     // Catch:{ Exception -> 0x0045 }
            java.io.File r2 = r3.b((java.lang.String) r2)     // Catch:{ Exception -> 0x0045 }
            r1.add(r2)     // Catch:{ Exception -> 0x0045 }
            goto L_0x0022
        L_0x0038:
            b(r5, r1)     // Catch:{ Exception -> 0x0045 }
