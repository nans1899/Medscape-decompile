...
public class FastParser<T extends FastJsonResponse> {
    ...
    private static final char[] zag = {Advice.OffsetMapping.ForOrigin.Renderer.ForReturnTypeName.SYMBOL, 'u', 'e'};
    private static final char[] zah = {Advice.OffsetMapping.ForOrigin.Renderer.ForReturnTypeName.SYMBOL, 'u', 'e', '\"'};
    private static final char[] zai = {'a', 'l', Advice.OffsetMapping.ForOrigin.Renderer.ForJavaSignature.SYMBOL, 'e'};
    private static final char[] zaj = {'a', 'l', Advice.OffsetMapping.ForOrigin.Renderer.ForJavaSignature.SYMBOL, 'e', '\"'};
