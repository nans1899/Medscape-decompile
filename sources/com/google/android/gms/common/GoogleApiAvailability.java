...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public Dialog getErrorDialog(Activity activity, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        return zaa((Context) activity, i, zad.zaa(activity, getErrorResolutionIntent(activity, i, Constants.APPBOY_PUSH_NOTIFICATION_SOUND_DEFAULT_VALUE), i2), onCancelListener);
    }
    ...
    public final boolean zaa(Activity activity, LifecycleFragment lifecycleFragment, int i, int i2, DialogInterface.OnCancelListener onCancelListener) {
        Dialog zaa2 = zaa((Context) activity, i, zad.zaa(lifecycleFragment, getErrorResolutionIntent(activity, i, Constants.APPBOY_PUSH_NOTIFICATION_SOUND_DEFAULT_VALUE), 2), onCancelListener);
        if (zaa2 == null) {
            return false;
        }
    ...
    public void showErrorNotification(Context context, int i) {
        zaa(context, i, (String) null, getErrorResolutionPendingIntent(context, i, 0, Constants.APPBOY_PUSH_CUSTOM_NOTIFICATION_ID));
    }
    ...
    public final zabl zaa(Context context, zabk zabk) {
        ...
        intentFilter.addDataScheme(net.media.android.bidder.base.common.Constants.APP_PACKAGE);
