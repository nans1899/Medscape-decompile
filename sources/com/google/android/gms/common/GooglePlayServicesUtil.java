...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int i, Activity activity, Fragment fragment, int i2, DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog zaa = GoogleApiAvailability.zaa((Context) activity, i, zad.zaa(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i, Constants.APPBOY_PUSH_NOTIFICATION_SOUND_DEFAULT_VALUE), i2), onCancelListener);
        if (zaa == null) {
            return false;
        }
