...
public class zzax {
    ...
    public static java.lang.String zza(android.content.ContentResolver r10, java.lang.String r11, java.lang.String r12) {
        /*
            ...
            monitor-enter(r12)
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzbw     // Catch:{ all -> 0x00f2 }
            r1 = 1
            r2 = 0
            r3 = 0
            if (r0 != 0) goto L_0x002a
            java.util.concurrent.atomic.AtomicBoolean r0 = zzbv     // Catch:{ all -> 0x00f2 }
            r0.set(r2)     // Catch:{ all -> 0x00f2 }
            java.util.HashMap r0 = new java.util.HashMap     // Catch:{ all -> 0x00f2 }
            r0.<init>()     // Catch:{ all -> 0x00f2 }
            zzbw = r0     // Catch:{ all -> 0x00f2 }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00f2 }
            r0.<init>()     // Catch:{ all -> 0x00f2 }
            zzcb = r0     // Catch:{ all -> 0x00f2 }
            zzcc = r2     // Catch:{ all -> 0x00f2 }
            android.net.Uri r0 = CONTENT_URI     // Catch:{ all -> 0x00f2 }
            com.google.android.gms.internal.icing.zzba r4 = new com.google.android.gms.internal.icing.zzba     // Catch:{ all -> 0x00f2 }
        ...
        L_0x002a:
            ...
            java.util.HashMap<java.lang.String, java.lang.Boolean> r0 = zzbx     // Catch:{ all -> 0x00f2 }
            r0.clear()     // Catch:{ all -> 0x00f2 }
            java.util.HashMap<java.lang.String, java.lang.Integer> r0 = zzby     // Catch:{ all -> 0x00f2 }
            r0.clear()     // Catch:{ all -> 0x00f2 }
            java.util.HashMap<java.lang.String, java.lang.Long> r0 = zzbz     // Catch:{ all -> 0x00f2 }
            r0.clear()     // Catch:{ all -> 0x00f2 }
            java.util.HashMap<java.lang.String, java.lang.Float> r0 = zzca     // Catch:{ all -> 0x00f2 }
            r0.clear()     // Catch:{ all -> 0x00f2 }
            java.lang.Object r0 = new java.lang.Object     // Catch:{ all -> 0x00f2 }
            r0.<init>()     // Catch:{ all -> 0x00f2 }
            zzcb = r0     // Catch:{ all -> 0x00f2 }
            zzcc = r2     // Catch:{ all -> 0x00f2 }
        L_0x0054:
            java.lang.Object r0 = zzcb     // Catch:{ all -> 0x00f2 }
            java.util.HashMap<java.lang.String, java.lang.String> r4 = zzbw     // Catch:{ all -> 0x00f2 }
            boolean r4 = r4.containsKey(r11)     // Catch:{ all -> 0x00f2 }
            if (r4 == 0) goto L_0x006b
            java.util.HashMap<java.lang.String, java.lang.String> r10 = zzbw     // Catch:{ all -> 0x00f2 }
        ...
        L_0x0069:
            ...
            return r3
        L_0x006b:
            java.lang.String[] r4 = zzcd     // Catch:{ all -> 0x00f2 }
        ...
        L_0x006f:
            ...
            boolean r0 = zzcc     // Catch:{ all -> 0x00f2 }
            if (r0 == 0) goto L_0x0085
            java.util.HashMap<java.lang.String, java.lang.String> r0 = zzbw     // Catch:{ all -> 0x00f2 }
            boolean r0 = r0.isEmpty()     // Catch:{ all -> 0x00f2 }
            if (r0 == 0) goto L_0x00a7
        L_0x0085:
            java.lang.String[] r0 = zzcd     // Catch:{ all -> 0x00f2 }
            java.util.HashMap<java.lang.String, java.lang.String> r2 = zzbw     // Catch:{ all -> 0x00f2 }
            java.util.Map r10 = zza(r10, r0)     // Catch:{ all -> 0x00f2 }
            r2.putAll(r10)     // Catch:{ all -> 0x00f2 }
            zzcc = r1     // Catch:{ all -> 0x00f2 }
            java.util.HashMap<java.lang.String, java.lang.String> r10 = zzbw     // Catch:{ all -> 0x00f2 }
