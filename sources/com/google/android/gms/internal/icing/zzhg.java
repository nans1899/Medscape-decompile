...
interface zzhg {
    ...
    void zza(int i, zzct zzct) throws IOException;

    <K, V> void zza(int i, zzey<K, V> zzey, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzfu zzfu) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzfu zzfu) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzfu zzfu) throws IOException;

    void zzb(int i, List<zzct> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzfu zzfu) throws IOException;
