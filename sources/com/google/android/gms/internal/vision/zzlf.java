...
final class zzlf {
    ...
    public static boolean zzg(byte[] bArr) {
        return zzade.zzf(bArr, 0, bArr.length);
    }
    ...
    static int zza(CharSequence charSequence, byte[] bArr, int i, int i2) {
        return zzade.zzb(charSequence, bArr, i, i2);
    }

    static String zzh(byte[] bArr, int i, int i2) throws zzin {
        return zzade.zzh(bArr, i, i2);
    }

    static {
        zzlh zzlh;
        if (!(zzld.zzje() && zzld.zzjf()) || zzgl.zzel()) {
            zzlh = new zzlg();
        } else {
            zzlh = new zzli();
        }
