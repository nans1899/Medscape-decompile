...
final class zzli extends zzlh {
    ...
    public final int zzb(int r16, byte[] r17, int r18, int r19) {
        ...
        L_0x001e:
            ...
            long r13 = r11 + r9
            byte r3 = com.google.android.gms.internal.vision.zzld.zza(r0, r11)
        ...
        L_0x0032:
            ...
            long r11 = r7 + r9
            byte r1 = com.google.android.gms.internal.vision.zzld.zza(r0, r7)
        ...
        L_0x006d:
            int r2 = r2 + -2
            long r13 = r7 + r9
            byte r7 = com.google.android.gms.internal.vision.zzld.zza(r0, r7)
        ...
        L_0x0083:
            long r7 = r13 + r9
            byte r1 = com.google.android.gms.internal.vision.zzld.zza(r0, r13)
        ...
        L_0x0093:
            int r2 = r2 + -3
            long r13 = r7 + r9
            byte r3 = com.google.android.gms.internal.vision.zzld.zza(r0, r7)
    ...
    public final String zzh(byte[] bArr, int i, int i2) throws zzin {
        if ((i | i2 | ((bArr.length - i) - i2)) >= 0) {
            ...
            int i4 = 0;
            while (r13 < i3) {
                byte zza = zzld.zza(bArr, (long) r13);
                if (!zzle.zzd(zza)) {
                    break;
                }
                i = r13 + 1;
            ...
            while (r13 < i3) {
                int i6 = r13 + 1;
                byte zza2 = zzld.zza(bArr, (long) r13);
                if (zzle.zzd(zza2)) {
                    int i7 = i5 + 1;
                    ...
                    if (i6 < i3 - 1) {
                        int i9 = i6 + 1;
                        int i10 = i9 + 1;
                        zzle.zza(zza2, zzld.zza(bArr, (long) i6), zzld.zza(bArr, (long) i9), cArr, i5);
                        r13 = i10;
                        i5++;
                    } else {
                        throw zzin.zzho();
                    ...
                    int i11 = i6 + 1;
                    byte zza4 = zzld.zza(bArr, (long) i6);
                    int i12 = i11 + 1;
                    zzle.zza(zza2, zza4, zzld.zza(bArr, (long) i11), zzld.zza(bArr, (long) i12), cArr, i5);
                    r13 = i12 + 1;
                    i5 = i5 + 1 + 1;
                } else {
                    throw zzin.zzho();
    ...
    public final int zzb(java.lang.CharSequence r23, byte[] r24, int r25, int r26) {
        ...
        L_0x001a:
            ...
            long r11 = r11 + r4
            byte r3 = (byte) r13
            com.google.android.gms.internal.vision.zzld.zza((byte[]) r1, (long) r4, (byte) r3)
            int r2 = r2 + 1
            r4 = r11
            goto L_0x001a
        L_0x002f:
        ...
        L_0x0033:
            ...
            long r14 = r4 + r11
            byte r13 = (byte) r13
            com.google.android.gms.internal.vision.zzld.zza((byte[]) r1, (long) r4, (byte) r13)
            r4 = r11
            r12 = r14
        L_0x0047:
        ...
        L_0x004b:
            ...
            r5 = r5 | r13
            byte r5 = (byte) r5
            com.google.android.gms.internal.vision.zzld.zza((byte[]) r1, (long) r14, (byte) r5)
            r20 = r11
            r11 = 128(0x80, float:1.794E-43)
            r12 = r3
            r4 = r20
        ...
        L_0x007f:
            ...
            r5 = r5 | r11
            byte r5 = (byte) r5
            com.google.android.gms.internal.vision.zzld.zza((byte[]) r1, (long) r3, (byte) r5)
            r12 = r18
            r4 = 1
            goto L_0x0047
        L_0x00ae:
            ...
            byte r15 = (byte) r15
            com.google.android.gms.internal.vision.zzld.zza((byte[]) r1, (long) r4, (byte) r15)
            long r4 = r13 + r11
            int r15 = r2 >>> 12
            r15 = r15 & 63
            r11 = 128(0x80, float:1.794E-43)
            ...
            byte r12 = (byte) r12
            com.google.android.gms.internal.vision.zzld.zza((byte[]) r1, (long) r13, (byte) r12)
            r12 = 1
            long r14 = r4 + r12
            int r16 = r2 >>> 6
            r12 = r16 & 63
            r12 = r12 | r11
            byte r12 = (byte) r12
            com.google.android.gms.internal.vision.zzld.zza((byte[]) r1, (long) r4, (byte) r12)
            r4 = 1
            long r12 = r14 + r4
            r2 = r2 & 63
            r2 = r2 | r11
            byte r2 = (byte) r2
            com.google.android.gms.internal.vision.zzld.zza((byte[]) r1, (long) r14, (byte) r2)
            r2 = r3
        L_0x00fb:
            int r2 = r2 + 1
            r3 = 128(0x80, float:1.794E-43)
        ...
        L_0x0106:
            r2 = r3
        L_0x0107:
            com.google.android.gms.internal.vision.zzlj r0 = new com.google.android.gms.internal.vision.zzlj
            int r2 = r2 + -1
            r0.<init>(r2, r8)
            throw r0
        L_0x010f:
        ...
        L_0x0146:
            ...
            throw r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.vision.zzli.zzb(java.lang.CharSequence, byte[], int, int):int");
    }
    ...
    private static int zza(byte[] bArr, int i, long j, int i2) {
        ...
        if (i2 == 2) {
            return zzlf.zzf(i, (int) zzld.zza(bArr, j), (int) zzld.zza(bArr, j + 1));
        }
