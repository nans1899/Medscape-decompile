...
public final class zzdwd {
    ...
    public static int zzs(int i, int i2) {
        ...
        if (i < 0) {
            str = zzdwf.zzb("%s (%s) must not be negative", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i));
        } else if (i2 < 0) {
            ...
            str = zzdwf.zzb("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i), Integer.valueOf(i2));
        }
