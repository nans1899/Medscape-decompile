...
public final class zzbbg {
    ...
    public final void zza(ViewGroup viewGroup, zzvn zzvn, String str, String str2) {
        zzbbq.zzfe(str2);
        zza(viewGroup, zzvn, str, -65536, (int) ViewCompat.MEASURED_STATE_MASK);
    }
    ...
    public static void zza(Context context, String str, String str2, Bundle bundle, boolean z, zzbbl zzbbl) {
        ...
        bundle.putString(AdParameterKeys.OS, Build.VERSION.RELEASE);
        ...
        Uri.Builder appendQueryParameter = new Uri.Builder().scheme(RequestBuilders.DEFAULT_SCHEME).path("//pagead2.googlesyndication.com/pagead/gen_204").appendQueryParameter("id", str2);
