...
final class zzhf extends zzhd {
    ...
    public final void zza(int i) throws zzih {
        if (this.zzj != i) {
            throw zzih.zze();
        }
    }
    ...
    public final String zzj() throws IOException {
        ...
        if (zzv > 0 && zzv <= this.zzf - this.zzh) {
            String str = new String(this.zzd, this.zzh, zzv, zzic.zza);
            this.zzh += zzv;
            return str;
        } else if (zzv == 0) {
            return "";
    ...
    public final String zzk() throws IOException {
        ...
        if (zzv > 0) {
            ...
            int i2 = this.zzh;
            if (zzv <= i - i2) {
                String zzb = zzla.zzb(this.zzd, i2, zzv);
                this.zzh += zzv;
                return zzb;
            }
        }
    ...
    public final zzgr zzl() throws IOException {
        byte[] bArr;
        int zzv = zzv();
        if (zzv > 0) {
            int i = this.zzf;
            int i2 = this.zzh;
            if (zzv <= i - i2) {
                zzgr zza = zzgr.zza(this.zzd, i2, zzv);
                this.zzh += zzv;
                return zza;
            }
        }
    ...
    private final int zzv() throws java.io.IOException {
        ...
        L_0x006b:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzhf.zzv():int");
    }
    ...
    private final long zzw() throws java.io.IOException {
        ...
        L_0x00b8:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.measurement.zzhf.zzw():long");
    }
    ...
    public final int zzc(int i) throws zzih {
        if (i >= 0) {
            int zzu = i + zzu();
            int i2 = this.zzk;
            if (zzu <= i2) {
