...
class zzke<K extends Comparable<K>, V> extends AbstractMap<K, V> {
    private final int zza;
    /* access modifiers changed from: private */
    public List<zzkj> zzb;
    /* access modifiers changed from: private */
    public Map<K, V> zzc;
    private boolean zzd;
    ...
    static <FieldDescriptorType extends zzhr<FieldDescriptorType>> zzke<FieldDescriptorType, Object> zza(int i) {
        return new zzkd(i);
    }
    ...
    public final V put(K k, V v) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzkj remove = this.zzb.remove(i2 - 1);
            zzg().put((Comparable) remove.getKey(), remove.getValue());
        }
        this.zzb.add(i, new zzkj(this, k, v));
        return null;
    }
    ...
    public final V zzc(int i) {
        ...
        if (!this.zzc.isEmpty()) {
            ...
            this.zzb.add(new zzkj(this, (Map.Entry) it.next()));
            it.remove();
        }
        return value;
    }
    ...
    public Set<Map.Entry<K, V>> entrySet() {
        if (this.zze == null) {
            this.zze = new zzkl(this, (zzkd) null);
        }
        return this.zze;
    }
    ...
    public final Set<Map.Entry<K, V>> zze() {
        if (this.zzg == null) {
            this.zzg = new zzkf(this, (zzkd) null);
        }
        return this.zzg;
    }
    ...
    public boolean equals(Object obj) {
        ...
        int zzc2 = zzc();
        if (zzc2 != zzke.zzc()) {
            return entrySet().equals(zzke.entrySet());
        }
        for (int i = 0; i < zzc2; i++) {
            if (!zzb(i).equals(zzke.zzb(i))) {
                return false;
            }
        }
        if (zzc2 != size) {
            return this.zzc.equals(zzke.zzc);
        }
        return true;
    }
    ...
    /* synthetic */ zzke(int i, zzkd zzkd) {
        this(i);
    }
}
