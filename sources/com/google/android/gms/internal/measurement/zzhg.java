...
public abstract class zzhg extends zzgo {
    ...
    public static final boolean zzc = zzkx.zza();
    zzhj zza;
    ...
    public abstract void zza(int i, zzgr zzgr) throws IOException;

    public abstract void zza(int i, zzjh zzjh) throws IOException;

    /* access modifiers changed from: package-private */
    public abstract void zza(int i, zzjh zzjh, zzjz zzjz) throws IOException;
    ...
    public abstract void zza(zzgr zzgr) throws IOException;

    public abstract void zza(zzjh zzjh) throws IOException;
    ...
    public abstract void zzb(int i, zzgr zzgr) throws IOException;
    ...
    /* compiled from: com.google.android.gms:play-services-measurement-base@@17.6.0 */
    private static class zza extends zzhg {
        ...
        public final void zza(int i, zzgr zzgr) throws IOException {
            zza(i, 2);
            zza(zzgr);
        }
        ...
        /* access modifiers changed from: package-private */
        public final void zza(int i, zzjh zzjh, zzjz zzjz) throws IOException {
            zza(i, 2);
            zzgh zzgh = (zzgh) zzjh;
            int zzbl = zzgh.zzbl();
            if (zzbl == -1) {
            ...
            zzb(zzbl);
            zzjz.zza(zzjh, (zzlo) this.zza);
        }

        public final void zza(int i, zzjh zzjh) throws IOException {
            zza(1, 3);
            zzc(2, i);
            zza(3, 2);
            zza(zzjh);
        ...
        public final void zzb(int i, zzgr zzgr) throws IOException {
            zza(1, 3);
            zzc(2, i);
            zza(3, zzgr);
            zza(1, 4);
        ...
        public final void zza(zzjh zzjh) throws IOException {
            zzb(zzjh.zzbo());
            zzjh.zza(this);
        }
        ...
        public final void zzb(int i) throws IOException {
            if (!zzhg.zzc || zzgk.zza() || zza() < 5) {
                ...
                int i4 = this.zze;
                this.zze = i4 + 1;
                zzkx.zza(bArr3, (long) i4, (byte) i);
            } else {
                byte[] bArr4 = this.zzb;
                int i5 = this.zze;
                this.zze = i5 + 1;
                zzkx.zza(bArr4, (long) i5, (byte) (i | 128));
                int i6 = i >>> 7;
                if ((i6 & -128) == 0) {
                    byte[] bArr5 = this.zzb;
                    int i7 = this.zze;
                    this.zze = i7 + 1;
                    zzkx.zza(bArr5, (long) i7, (byte) i6);
                    return;
                }
                byte[] bArr6 = this.zzb;
                int i8 = this.zze;
                this.zze = i8 + 1;
                zzkx.zza(bArr6, (long) i8, (byte) (i6 | 128));
                int i9 = i6 >>> 7;
                if ((i9 & -128) == 0) {
                    byte[] bArr7 = this.zzb;
                    int i10 = this.zze;
                    this.zze = i10 + 1;
                    zzkx.zza(bArr7, (long) i10, (byte) i9);
                    return;
                }
                byte[] bArr8 = this.zzb;
                int i11 = this.zze;
                this.zze = i11 + 1;
                zzkx.zza(bArr8, (long) i11, (byte) (i9 | 128));
                int i12 = i9 >>> 7;
                if ((i12 & -128) == 0) {
                    byte[] bArr9 = this.zzb;
                    int i13 = this.zze;
                    this.zze = i13 + 1;
                    zzkx.zza(bArr9, (long) i13, (byte) i12);
                    return;
                }
                byte[] bArr10 = this.zzb;
                int i14 = this.zze;
                this.zze = i14 + 1;
                zzkx.zza(bArr10, (long) i14, (byte) (i12 | 128));
                byte[] bArr11 = this.zzb;
                int i15 = this.zze;
                this.zze = i15 + 1;
                zzkx.zza(bArr11, (long) i15, (byte) (i12 >>> 7));
            }
        }
        ...
        public final void zza(long j) throws IOException {
            if (!zzhg.zzc || zza() < 10) {
                ...
                while ((j & -128) != 0) {
                    ...
                    int i3 = this.zze;
                    this.zze = i3 + 1;
                    zzkx.zza(bArr3, (long) i3, (byte) ((((int) j) & 127) | 128));
                    j >>>= 7;
                }
                byte[] bArr4 = this.zzb;
                int i4 = this.zze;
                this.zze = i4 + 1;
                zzkx.zza(bArr4, (long) i4, (byte) ((int) j));
            }
        }
        ...
        public final void zza(String str) throws IOException {
            ...
            try {
                ...
                if (zzg2 == zzg) {
                    int i2 = i + zzg2;
                    this.zze = i2;
                    int zza = zzla.zza(str, this.zzb, i2, zza());
                    this.zze = i;
                    zzb((zza - i) - zzg2);
                    this.zze = zza;
                    return;
    ...
    static int zzb(int i, zzjh zzjh, zzjz zzjz) {
        return zzg(i << 3) + zza(zzjh, zzjz);
    }
    ...
    public static int zzb(String str) {
        ...
        try {
            ...
            i = str.getBytes(zzic.zza).length;
        }
        return zzg(i) + i;
    }
    ...
    static int zza(zzjh zzjh, zzjz zzjz) {
        zzgh zzgh = (zzgh) zzjh;
        int zzbl = zzgh.zzbl();
        if (zzbl == -1) {
            zzbl = zzjz.zzb(zzgh);
    ...
    /* access modifiers changed from: package-private */
    public final void zza(String str, zzld zzld) throws IOException {
        zzb.logp(Level.WARNING, "com.google.protobuf.CodedOutputStream", "inefficientWriteStringNoTag", "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", zzld);
        byte[] bytes = str.getBytes(zzic.zza);
        try {
            zzb(bytes.length);
    ...
    @Deprecated
    static int zzc(int i, zzjh zzjh, zzjz zzjz) {
        int zzg = zzg(i << 3) << 1;
        zzgh zzgh = (zzgh) zzjh;
        int zzbl = zzgh.zzbl();
        if (zzbl == -1) {
