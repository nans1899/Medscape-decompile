...
final class zziv extends zzgl<Long> implements zzif, zzjt, RandomAccess {
    ...
    public final zzif zza(int i) {
        if (i >= this.zzc) {
            return new zziv(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    public final boolean addAll(Collection<? extends Long> collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zziv.zzb, 0, this.zzb, this.zzc, zziv.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    static {
        zziv zziv = new zziv(new long[0], 0);
        zza = zziv;
        zziv.zzb();
    }
}
