...
interface zzlo {
    ...
    void zza(int i, zzgr zzgr) throws IOException;

    <K, V> void zza(int i, zzjc<K, V> zzjc, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzjz zzjz) throws IOException;

    void zza(int i, String str) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzjz zzjz) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzjz zzjz) throws IOException;

    void zzb(int i, List<zzgr> list) throws IOException;

    @Deprecated
    void zzb(int i, List<?> list, zzjz zzjz) throws IOException;
