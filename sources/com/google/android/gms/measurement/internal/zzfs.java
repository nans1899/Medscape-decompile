...
final class zzfs extends Thread {
    private final Object zza;
    private final BlockingQueue<zzft<?>> zzb;
    private boolean zzc = false;
    private final /* synthetic */ zzfo zzd;

    public zzfs(zzfo zzfo, String str, BlockingQueue<zzft<?>> blockingQueue) {
        this.zzd = zzfo;
    ...
    public final void run() {
        ...
        L_0x0001:
            ...
            com.google.android.gms.measurement.internal.zzfo r1 = r5.zzd     // Catch:{ InterruptedException -> 0x000e }
        ...
        L_0x001b:
            java.util.concurrent.BlockingQueue<com.google.android.gms.measurement.internal.zzft<?>> r1 = r5.zzb     // Catch:{ all -> 0x0081 }
            java.lang.Object r1 = r1.poll()     // Catch:{ all -> 0x0081 }
            com.google.android.gms.measurement.internal.zzft r1 = (com.google.android.gms.measurement.internal.zzft) r1     // Catch:{ all -> 0x0081 }
        ...
        L_0x0034:
            ...
            java.util.concurrent.BlockingQueue<com.google.android.gms.measurement.internal.zzft<?>> r2 = r5.zzb     // Catch:{ all -> 0x007e }
            java.lang.Object r2 = r2.peek()     // Catch:{ all -> 0x007e }
            if (r2 != 0) goto L_0x0053
            com.google.android.gms.measurement.internal.zzfo r2 = r5.zzd     // Catch:{ all -> 0x007e }
        ...
        L_0x0053:
            ...
            com.google.android.gms.measurement.internal.zzfo r1 = r5.zzd     // Catch:{ all -> 0x0081 }
            java.lang.Object r1 = r1.zzg     // Catch:{ all -> 0x0081 }
            monitor-enter(r1)     // Catch:{ all -> 0x0081 }
            java.util.concurrent.BlockingQueue<com.google.android.gms.measurement.internal.zzft<?>> r2 = r5.zzb     // Catch:{ all -> 0x007b }
            java.lang.Object r2 = r2.peek()     // Catch:{ all -> 0x007b }
            if (r2 != 0) goto L_0x0079
            com.google.android.gms.measurement.internal.zzfo r0 = r5.zzd     // Catch:{ all -> 0x007b }
        ...
        synchronized (this.zzd.zzg) {
            if (!this.zzc) {
                ...
                if (this == this.zzd.zza) {
                    zzfs unused = this.zzd.zza = null;
                } else if (this == this.zzd.zzb) {
                    zzfs unused2 = this.zzd.zzb = null;
                } else {
