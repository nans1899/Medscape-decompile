...
public final class zzfi {
    ...
    public final void zza(String str) {
        ...
        if (resolveInfo.serviceInfo != null) {
            ...
            try {
                this.zza.zzq().zzw().zza("Install Referrer Service is", ConnectionTracker.getInstance().bindService(this.zza.zzm(), new Intent(intent), zzfl, 1) ? "available" : "not available");
            } catch (Exception e) {
