    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            L_0x0028:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.handmark.pulltorefresh.library.PullToRefreshListView.AnonymousClass1.<clinit>():void");
        }
    }
    ...
    public void onReset() {
        ...
        if (loadingLayout.getVisibility() == 0) {
            ...
            if (!(i4 == 0 || getState() == PullToRefreshBase.State.MANUAL_REFRESHING)) {
                ((ListView) this.mRefreshableView).setSelection(i3);
                setHeaderScroll(i);
            }
        }
        super.onReset();
