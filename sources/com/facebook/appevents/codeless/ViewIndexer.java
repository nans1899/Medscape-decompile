        ...
        if (activity != null) {
            ...
            final AnonymousClass1 r2 = new TimerTask() {
                ...
                public void run() {
                    /*
                        r6 = this;
                        android.app.Activity r0 = r0     // Catch:{ Exception -> 0x0081 }
                        android.view.Window r0 = r0.getWindow()     // Catch:{ Exception -> 0x0081 }
                        android.view.View r0 = r0.getDecorView()     // Catch:{ Exception -> 0x0081 }
                        android.view.View r0 = r0.getRootView()     // Catch:{ Exception -> 0x0081 }
                        boolean r1 = com.facebook.appevents.internal.ActivityLifecycleTracker.getIsAppIndexingEnabled()     // Catch:{ Exception -> 0x0081 }
                        if (r1 != 0) goto L_0x0015
                        return
                    L_0x0015:
                        boolean r1 = com.facebook.internal.InternalSettings.isUnityApp()     // Catch:{ Exception -> 0x0081 }
                        if (r1 == 0) goto L_0x001f
                        com.facebook.appevents.codeless.internal.UnityReflection.captureViewHierarchy()     // Catch:{ Exception -> 0x0081 }
                        return
                    L_0x001f:
                        java.util.concurrent.FutureTask r1 = new java.util.concurrent.FutureTask     // Catch:{ Exception -> 0x0081 }
                        com.facebook.appevents.codeless.ViewIndexer$ScreenshotTaker r2 = new com.facebook.appevents.codeless.ViewIndexer$ScreenshotTaker     // Catch:{ Exception -> 0x0081 }
                        r2.<init>(r0)     // Catch:{ Exception -> 0x0081 }
                        r1.<init>(r2)     // Catch:{ Exception -> 0x0081 }
                        com.facebook.appevents.codeless.ViewIndexer r2 = com.facebook.appevents.codeless.ViewIndexer.this     // Catch:{ Exception -> 0x0081 }
                        android.os.Handler r2 = r2.uiThreadHandler     // Catch:{ Exception -> 0x0081 }
                        r2.post(r1)     // Catch:{ Exception -> 0x0081 }
                        java.lang.String r2 = ""
                        r3 = 1
                        java.util.concurrent.TimeUnit r5 = java.util.concurrent.TimeUnit.SECONDS     // Catch:{ Exception -> 0x0040 }
                        java.lang.Object r1 = r1.get(r3, r5)     // Catch:{ Exception -> 0x0040 }
                        java.lang.String r1 = (java.lang.String) r1     // Catch:{ Exception -> 0x0040 }
                        r2 = r1
                        goto L_0x004a
                    L_0x0040:
                        r1 = move-exception
                        java.lang.String r3 = com.facebook.appevents.codeless.ViewIndexer.TAG     // Catch:{ Exception -> 0x0081 }
                        java.lang.String r4 = "Failed to take screenshot."
                        android.util.Log.e(r3, r4, r1)     // Catch:{ Exception -> 0x0081 }
                    L_0x004a:
                        org.json.JSONObject r1 = new org.json.JSONObject     // Catch:{ Exception -> 0x0081 }
                        r1.<init>()     // Catch:{ Exception -> 0x0081 }
                        java.lang.String r3 = "screenname"
                        java.lang.String r4 = r1     // Catch:{ JSONException -> 0x006e }
                        r1.put(r3, r4)     // Catch:{ JSONException -> 0x006e }
                        java.lang.String r3 = "screenshot"
                        r1.put(r3, r2)     // Catch:{ JSONException -> 0x006e }
                        org.json.JSONArray r2 = new org.json.JSONArray     // Catch:{ JSONException -> 0x006e }
                        r2.<init>()     // Catch:{ JSONException -> 0x006e }
                        org.json.JSONObject r0 = com.facebook.appevents.codeless.internal.ViewHierarchy.getDictionaryOfView(r0)     // Catch:{ JSONException -> 0x006e }
                        r2.put(r0)     // Catch:{ JSONException -> 0x006e }
                        java.lang.String r0 = "view"
                        r1.put(r0, r2)     // Catch:{ JSONException -> 0x006e }
                        goto L_0x0077
                    L_0x006e:
                        java.lang.String r0 = com.facebook.appevents.codeless.ViewIndexer.TAG     // Catch:{ Exception -> 0x0081 }
                        java.lang.String r2 = "Failed to create JSONObject"
                        android.util.Log.e(r0, r2)     // Catch:{ Exception -> 0x0081 }
                    L_0x0077:
                        java.lang.String r0 = r1.toString()     // Catch:{ Exception -> 0x0081 }
                        com.facebook.appevents.codeless.ViewIndexer r1 = com.facebook.appevents.codeless.ViewIndexer.this     // Catch:{ Exception -> 0x0081 }
                        r1.sendToServer(r0)     // Catch:{ Exception -> 0x0081 }
                        goto L_0x008b
                    L_0x0081:
                        r0 = move-exception
