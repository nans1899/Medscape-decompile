...
class SessionLogger {
    private static final long[] INACTIVE_SECONDS_QUANTA = {300000, 900000, 1800000, Constants.HOUR_IN_MILLIS, Constants.BG_UPDATE_TIME_IN_MILLIS, 43200000, Constants.DAY_IN_MILLIS, 172800000, 259200000, 604800000, 1209600000, 1814400000, 2419200000L, 5184000000L, 7776000000L, 10368000000L, 12960000000L, 15552000000L, 31536000000L};
    ...
    public static void logDeactivateApp(String str, SessionInfo sessionInfo, String str2) {
        ...
        new InternalAppEventsLogger(str, str2, (AccessToken) null).logEvent(AppEventsConstants.EVENT_NAME_DEACTIVATED_APP, ((double) l.longValue()) / 1000.0d, bundle);
    }
