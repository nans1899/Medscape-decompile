...
class InAppPurchaseEventManager {
    ...
    private static final long SUBSCRIPTION_HARTBEAT_INTERVAL = 43200;
    ...
    private static String getSkuDetail(Context context, String str, Object obj, boolean z) {
        ArrayList arrayList = new ArrayList();
        arrayList.add(str);
        return getSkuDetails(context, arrayList, obj, z).get(str);
    }
    ...
    private static Map<String, String> readSkuDetailsFromCache(ArrayList<String> arrayList) {
        ...
        while (it.hasNext()) {
            ...
            if (string != null) {
                ...
                if (currentTimeMillis - Long.parseLong(split[0]) < SUBSCRIPTION_HARTBEAT_INTERVAL) {
    ...
    public static Map<String, SubscriptionType> getPurchasesSubs(Context context, Object obj) {
        ...
        while (it.hasNext()) {
            String next = it.next();
            SubscriptionType subsType = getSubsType(context, next, obj);
    ...
    private static SubscriptionType getSubsType(Context context, String str, Object obj) {
        String skuDetail;
        ...
        try {
            ...
            if (!jSONObject2.optString("purchaseToken").equals(jSONObject.get("purchaseToken"))) {
                if (currentTimeMillis - (jSONObject.getLong("purchaseTime") / 1000) < 86400 && (skuDetail = getSkuDetail(context, string, obj, true)) != null) {
            ...
            if (subscriptionType2 == null) {
                if (!string2.isEmpty()) {
                    if (currentTimeMillis - jSONObject2.getLong(LAST_LOGGED_TIME_SEC) > SUBSCRIPTION_HARTBEAT_INTERVAL) {
                        ...
                        subscriptionType2 = SubscriptionType.DUPLICATED;
                    }
                }
            }
