...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable, ByteChannel {
    ...
    public final byte m1517deprecated_getByte(long j) {
        return getByte(j);
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "size", imports = {}))
    /* renamed from: -deprecated_size  reason: not valid java name */
    public final long m1518deprecated_size() {
        return this.size;
    }
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if (size() != 0) {
            ...
            throw new EOFException("size < " + i + ": " + size() + " (to read code point prefixed 0x" + Util.toHexString(b3) + ASCIIPropertyListParser.ARRAY_END_TOKEN);
        }
        throw new EOFException();
    }
