...
public final class BitmapKt {
    ...
    public static /* synthetic */ Bitmap createBitmap$default(int i, int i2, Bitmap.Config config, int i3, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(config, Constants.CONFIG_FILE_NAME);
