...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        boolean z = i7 != 0;
        int i13 = i12;
        int printField = printField(cArr, i2, Advice.OffsetMapping.ForOrigin.Renderer.ForDescriptor.SYMBOL, i12, false, 0);
        int printField2 = printField(cArr, i3, 'h', printField, printField != i13, z ? 2 : 0);
        int printField3 = printField(cArr, i5, Advice.OffsetMapping.ForOrigin.Renderer.ForMethodName.SYMBOL, printField2, printField2 != i13, z ? 2 : 0);
        int printField4 = printField(cArr, i4, Advice.OffsetMapping.ForOrigin.Renderer.ForJavaSignature.SYMBOL, printField3, printField3 != i13, z ? 2 : 0);
        int printField5 = printField(cArr, i10, Advice.OffsetMapping.ForOrigin.Renderer.ForMethodName.SYMBOL, printField4, true, (!z || printField4 == i13) ? 0 : 3);
