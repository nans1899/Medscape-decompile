...
public final class LocationManagerCompat {
    ...
    public static boolean isLocationEnabled(LocationManager locationManager) {
        ...
        if (locationManager.isProviderEnabled(Logger.NETWORK) || locationManager.isProviderEnabled("gps")) {
            return true;
        }
        return false;
    }
    ...
    private static boolean registerGnssStatusCallback(final android.location.LocationManager r9, android.os.Handler r10, java.util.concurrent.Executor r11, androidx.core.location.GnssStatusCompat.Callback r12) {
        ...
        L_0x0083:
            ...
            androidx.core.location.LocationManagerCompat$1 r4 = new androidx.core.location.LocationManagerCompat$1     // Catch:{ all -> 0x0154 }
