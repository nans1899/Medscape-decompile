    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            ...
            public String toString() {
                return "FullSpanItem{mPosition=" + this.mPosition + ", mGapDir=" + this.mGapDir + ", mHasUnwantedGapAfter=" + this.mHasUnwantedGapAfter + ", mGapPerSpan=" + Arrays.toString(this.mGapPerSpan) + ASCIIPropertyListParser.DICTIONARY_END_TOKEN;
            }
        }
    }
